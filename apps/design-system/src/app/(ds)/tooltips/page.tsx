...
import { Section, SubSection, SpecBlock, TokenRow, TooltipDemo } from "@/components/ds/shared"
  ...
  return (
    <>
      <Section id="tooltips" title="10. Тултипы">
        ...
        {/* ── Preview first ── */}
        <SubSection id="tooltips-variants" title="Варианты" first />
        ...
        {/* ── Specs below ── */}
        <SpecBlock title="Анимация и правила">
