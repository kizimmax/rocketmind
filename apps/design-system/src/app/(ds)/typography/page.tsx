          ...
          <TabsContent value="scale">
            <div className="border border-border rounded-lg overflow-hidden">
              ...
              {[
                ...
                { label: "Copy-14",    size: "14px", mobileSize: "14px", weight: "400", cls: "leading-[1.4] tracking-[0.01em]",                                                                               tailwind: "text-[length:var(--text-14)] leading-[1.4] tracking-[0.01em]" },
          ...
          <TabsContent value="specimens">
            <div className="border border-border rounded-lg overflow-hidden">
              {[
                ...
                { label: "Copy-14", text: "Применение методологии позволило получить более 20 новых гипотез. Формат работы создаёт максимальный эффект вовлечённости и синергии в команде.", cls: "leading-[1.4] tracking-[0.01em]", size: "14px", mobileSize: "14px", letterSpacing: "0.01em", figmaSpacing: "1%", lineHeight: "1.4", figmaLineHeight: "140%", twCopy: "text-[length:var(--text-14)] leading-[1.4] tracking-[0.01em]" },
