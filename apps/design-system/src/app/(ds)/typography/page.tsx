          ...
          <TabsContent value="specimens">
            <div className="border border-border rounded-lg overflow-hidden">
              {[
                ...
                { label: "H2", text: "AI-агенты для вашего бизнеса", cls: "font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.02em] leading-[1.05]", size: "52px", mobileSize: "30px", letterSpacing: "-0.02em", figmaSpacing: "-2%", lineHeight: "1.05", figmaLineHeight: "105%", twCopy: "text-[length:var(--text-30)] md:text-[length:var(--text-52)] font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.02em] leading-[1.05]" },
                { label: "H3", text: "Аналитика и маркетинг без команды", cls: "font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.015em] leading-[1.1]", size: "32px", mobileSize: "24px", letterSpacing: "-0.015em", figmaSpacing: "-1.5%", lineHeight: "1.1", figmaLineHeight: "110%", twCopy: "text-[length:var(--text-24)] md:text-[length:var(--text-32)] font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.015em] leading-[1.1]" },
                { label: "H4", text: "Выберите агента под задачу", cls: "font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.01em] leading-[1.2]", size: "24px", mobileSize: "18px", letterSpacing: "-0.01em", figmaSpacing: "-1%", lineHeight: "1.2", figmaLineHeight: "120%", twCopy: "text-[length:var(--text-18)] md:text-[length:var(--text-24)] font-[family-name:var(--font-heading-family)] font-bold uppercase tracking-[-0.01em] leading-[1.2]" },
