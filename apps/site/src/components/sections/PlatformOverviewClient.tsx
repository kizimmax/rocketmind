...
const PLATFORM_CELL_DEFAULTS: PlatformCell[] = [
  {
    label: "Методология",
    title: "бизнес-дизайн",
    description:
      "Методология, которая помогает проектировать бизнес как систему: от\u00A0ценности для клиента и\u00A0модели дохода до\u00A0логики роста, развития новых направлений и\u00A0принятия стратегических решений.",
  },
  {
...
export function PlatformOverviewClient({ cells }: PlatformOverviewClientProps) {
  const pick = (i: number): PlatformCell => cells[i] ?? PLATFORM_CELL_DEFAULTS[i];
  const c0 = pick(0);
  const c1 = pick(1);
  const c2 = pick(2);
      ...
      <div className="mx-auto w-full max-w-[1512px] px-5 md:px-8 xl:px-14">
        ...
        >
          ...
          >
            ...
            >
              <Heading label={c0.label} title={c0.title} />
              <BodyText>{c0.description}</BodyText>
            </div>
          </div>
          ...
          >
            ...
            >
              <Heading label={c1.label} title={c1.title} />
              <BodyText>{c1.description}</BodyText>
            </div>
          ...
          >
            ...
            >
              <Heading label={c2.label} title={c2.title} />
              <BodyText>{c2.description}</BodyText>
            </div>
