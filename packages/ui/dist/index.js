...
var Toaster = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsx22(
    Sonner,
    {
      ...
      icons: {
        success: /* @__PURE__ */ jsx22(CircleCheckIcon, { className: "size-4" }),
        info: /* @__PURE__ */ jsx22(InfoIcon, { className: "size-4" }),
        warning: /* @__PURE__ */ jsx22(TriangleAlertIcon, { className: "size-4" }),
        error: /* @__PURE__ */ jsx22(OctagonXIcon, { className: "size-4" }),
        loading: /* @__PURE__ */ jsx22(Loader2Icon, { className: "size-4 animate-spin" })
      },
      style: {
...
function Table({ className, ...props }) {
  return /* @__PURE__ */ jsx24("div", { "data-slot": "table-container", className: "relative w-full overflow-auto", children: /* @__PURE__ */ jsx24(
    "table",
    {
      "data-slot": "table",
...
function Slider({
  ...
  return /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx27("div", { className: "absolute inset-x-0 top-[3px] h-[2px] bg-border" }),
        /* @__PURE__ */ jsx27(
          "div",
          {
        ...
        onChange && !disabled && /* @__PURE__ */ jsx27(
          "input",
          {
            type: "range",
            min,
...
function RichText({ text, className, blockClassName }) {
  ...
  return /* @__PURE__ */ jsx29("span", { className: cn("block", className), children: blocks.map((b, i) => {
    const isFirst = i === 0;
    if (b.kind === "ul") {
      return /* @__PURE__ */ jsx29(
        "ul",
        {
          ...
          children: b.items.map((it, j) => /* @__PURE__ */ jsx29("li", { children: it }, j))
        },
        i
      );
    }
    ...
    return /* @__PURE__ */ jsx29("p", { className: cn(!isFirst && "mt-1", blockClassName), children: b.lines.map((l, j) => /* @__PURE__ */ jsxs12("span", { children: [
      j > 0 && /* @__PURE__ */ jsx29("br", {}),
      l
    ] }, j)) }, i);
  }) });
}
...
function StyledParagraphs({
  ...
  return /* @__PURE__ */ jsx30("div", { className: cn("flex flex-col gap-3", className), children: paragraphs.map((p, i) => /* @__PURE__ */ jsx30(
    RichText,
    {
      text: p.text,
...
function PartnershipBlock({
  ...
  return /* @__PURE__ */ jsxs13(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs13("div", { className: "flex flex-col gap-8 lg:w-1/2 lg:shrink-0 lg:max-w-[560px]", children: [
          /* @__PURE__ */ jsxs13("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx31("span", { className: "font-[family-name:var(--font-mono-family)] text-[18px] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[var(--rm-yellow-100)]", children: caption }),
            /* @__PURE__ */ jsxs13("div", { className: "flex flex-col gap-6", children: [
              /* @__PURE__ */ jsx31("h3", { className: "font-[family-name:var(--font-heading-family)] text-[28px] md:text-[36px] lg:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em]", children: title }),
              hasParagraphs && /* @__PURE__ */ jsx31(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
            ] })
          ] }),
          logos.length > 0 && /* @__PURE__ */ jsx31("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4 items-center", children: logos.map((logo, i) => /* @__PURE__ */ jsx31(
            "img",
            {
              src: logo.src,
              alt: logo.alt,
        ...
        photos.length > 0 && /* @__PURE__ */ jsx31("div", { className: "grid grid-cols-2 gap-4 lg:w-1/2 lg:max-w-[696px]", children: photos.slice(0, 4).map((photo, i) => /* @__PURE__ */ jsx31("div", { className: "aspect-[340/252] overflow-hidden", children: /* @__PURE__ */ jsx31(
          "img",
          {
            src: photo.src,
            alt: photo.alt || "",
...
function PartnershipsMini({
  ...
  return /* @__PURE__ */ jsx32(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs14("div", { className: "mx-auto flex max-w-[1512px] flex-col gap-8 lg:flex-row lg:items-center lg:justify-between", children: [
        /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-5 lg:max-w-[720px]", children: [
          /* @__PURE__ */ jsx32("h2", { className: "font-[family-name:var(--font-heading-family)] text-[24px] md:text-[32px] font-bold uppercase leading-[1.1] tracking-[-0.02em] text-[#0A0A0A]", children: title }),
          /* @__PURE__ */ jsx32("p", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-14)] md:text-[length:var(--text-16)] font-medium uppercase leading-[1.3] tracking-[0.01em] text-[#0A0A0A]", children: description })
        ] }),
        logos.length > 0 && /* @__PURE__ */ jsx32("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4 items-center lg:max-w-[360px] lg:w-full", children: logos.map((logo, i) => /* @__PURE__ */ jsx32(
          "img",
          {
            src: logo.src,
            alt: logo.alt,
...
function ProductCard({
  ...
  const content = /* @__PURE__ */ jsxs15(Fragment2, { children: [
    /* @__PURE__ */ jsx33("div", { className: "hidden md:block", children: /* @__PURE__ */ jsx33(
      GlowingEffect,
      {
        spread: 40,
        glow: false,
    ...
    /* @__PURE__ */ jsx33("div", { className: "absolute top-[2px] right-[2px] z-10 flex items-center justify-center w-10 h-10 rounded-[4px] text-[#404040] transition-all duration-200 group-hover:text-[#F0F0F0] group-hover:-top-[2px] group-hover:-right-[2px]", children: /* @__PURE__ */ jsx33("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx33(
      "path",
      {
    ...
    /* @__PURE__ */ jsxs15("div", { className: cn("flex flex-col", icon ? "gap-6 md:gap-8" : ""), children: [
      icon && /* @__PURE__ */ jsxs15("div", { className: "relative flex items-center overflow-visible", children: [
        /* @__PURE__ */ jsx33("div", { className: "w-[120px] h-[120px] shrink-0 z-0", children: icon }),
        hasExperts && /* @__PURE__ */ jsxs15("div", { className: "flex items-center -ml-[18px] pb-10 pt-2 justify-end min-w-0", children: [
          shown.map((e, i) => /* @__PURE__ */ jsx33(
            "div",
            {
              className: cn(
          ...
          extra > 0 && /* @__PURE__ */ jsx33("div", { className: "w-[72px] h-[72px] min-w-[52px] min-h-[52px] rounded-full bg-[#1A1A1A] flex items-center justify-center -ml-4 z-[1]", children: /* @__PURE__ */ jsxs15("span", { className: "font-heading text-[24px] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0]", children: [
            "+",
            extra
          ] }) })
        ] }),
        tag && /* @__PURE__ */ jsx33("span", { className: "absolute left-0 bottom-[-22px] inline-flex items-center px-2.5 py-1 bg-[#3D3300] border border-[#4A3C00] font-[family-name:var(--font-mono-family)] text-[12px] font-medium uppercase tracking-[0.02em] leading-[1.2] text-[#FFE466] z-10", children: tag })
      ] }),
      tag && !icon && /* @__PURE__ */ jsx33("span", { className: "inline-flex self-start items-center px-2.5 py-1 mb-4 md:mb-5 bg-[#3D3300] border border-[#4A3C00] font-[family-name:var(--font-mono-family)] text-[12px] font-medium uppercase tracking-[0.02em] leading-[1.2] text-[#FFE466]", children: tag }),
      /* @__PURE__ */ jsxs15("div", { className: "flex flex-col gap-4 md:gap-5", children: [
        /* @__PURE__ */ jsx33("h3", { className: "font-heading font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0] line-clamp-2 min-h-[2.4em] text-[20px] md:text-[clamp(16px,1.6vw,24px)]", children: title }),
        /* @__PURE__ */ jsx33("p", { className: "text-[14px] leading-[1.32] tracking-[0.01em] text-[#939393] h-[54px] overflow-hidden line-clamp-3", children: description })
      ] })
    ] })
  ] });
  if (href) {
    return /* @__PURE__ */ jsx33(Link2, { href, className: rootCn, children: content });
  }
  return /* @__PURE__ */ jsx33("div", { className: rootCn, children: content });
}

// src/components/ui/product-image-card.tsx
import Link3 from "next/link";
import { Fragment as Fragment3, jsx as jsx34, jsxs as jsxs16 } from "react/jsx-runtime";
...
function ProductImageCard({
  ...
  if (variant === "wide") {
    ...
    const inner2 = /* @__PURE__ */ jsxs16(Fragment3, { children: [
      /* @__PURE__ */ jsx34("div", { className: "hidden md:block", children: /* @__PURE__ */ jsx34(GlowingEffect, { spread: 40, glow: false, disabled: false, proximity: 40, inactiveZone: 0.01, borderWidth: 1, variant: "yellow" }) }),
      /* @__PURE__ */ jsx34("div", { className: "absolute top-[2px] right-[2px] z-10 flex items-center justify-center w-10 h-10 rounded-[4px] text-[#404040] transition-all duration-200 group-hover:text-[#F0F0F0] group-hover:-top-[2px] group-hover:-right-[2px]", children: /* @__PURE__ */ jsx34("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx34("path", { d: "M1 10L10 1M10 1H3M10 1V8", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
      /* @__PURE__ */ jsxs16("div", { className: "relative md:w-1/2 h-[220px] md:h-auto md:self-stretch overflow-hidden shrink-0", children: [
        image ? /* @__PURE__ */ jsx34("img", { src: image, alt: "", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx34(CoverSkeleton, {}),
        tag && /* @__PURE__ */ jsx34("span", { className: cn(tagCn, "hidden md:inline-flex absolute left-0 top-0 z-10"), children: tag })
      ] }),
      tag && /* @__PURE__ */ jsx34("div", { className: "md:hidden -mt-[22px]", children: /* @__PURE__ */ jsx34("span", { className: tagCn, children: tag }) }),
      /* @__PURE__ */ jsxs16("div", { className: "md:flex-1 flex flex-col md:justify-between gap-4 mt-6 md:mt-0 min-w-0", children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsx34("h3", { className: "font-heading font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0] line-clamp-2 min-h-[2.4em] text-[20px] md:text-[clamp(16px,1.6vw,24px)]", children: title }),
          /* @__PURE__ */ jsx34("p", { className: "text-[14px] leading-[1.32] tracking-[0.01em] text-[#939393] line-clamp-3 h-[54px] overflow-hidden", children: description })
        ] }),
        factoids.length > 0 && /* @__PURE__ */ jsx34("div", { className: "hidden md:flex flex-col gap-4", children: factoids.slice(0, maxFactoids).map((f, i) => /* @__PURE__ */ jsxs16("div", { className: "flex gap-3 items-start", children: [
          /* @__PURE__ */ jsx34("span", { className: "font-heading text-[24px] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0] shrink-0 w-[66px]", children: f.number }),
          /* @__PURE__ */ jsx34("p", { className: "text-[14px] leading-[1.32] tracking-[0.01em] text-[#F0F0F0] pt-[5px] line-clamp-2", children: f.text })
        ] }, i)) })
      ] })
    ] });
    if (href) return /* @__PURE__ */ jsx34(Link3, { href, className: rootCn2, children: inner2 });
    return /* @__PURE__ */ jsx34("div", { className: rootCn2, children: inner2 });
  }
  const rootCn = cn(
  ...
  const inner = /* @__PURE__ */ jsxs16(Fragment3, { children: [
    /* @__PURE__ */ jsx34(GlowingEffect, { spread: 40, glow: false, disabled: false, proximity: 40, inactiveZone: 0.01, borderWidth: 2, variant: "yellow" }),
    /* @__PURE__ */ jsx34("div", { className: "absolute top-[2px] right-[2px] z-10 flex items-center justify-center w-10 h-10 rounded-[4px] text-[#404040] transition-all duration-200 group-hover:text-[#F0F0F0] group-hover:-top-[2px] group-hover:-right-[2px]", children: /* @__PURE__ */ jsx34("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx34("path", { d: "M1 10L10 1M10 1H3M10 1V8", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
    /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-6 md:gap-8", children: [
      /* @__PURE__ */ jsxs16("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ jsx34("div", { className: "w-full h-[220px] overflow-hidden", children: image ? /* @__PURE__ */ jsx34("img", { src: image, alt: "", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx34(CoverSkeleton, {}) }),
        tag && /* @__PURE__ */ jsx34("div", { className: "-mt-[22px]", children: /* @__PURE__ */ jsx34("span", { className: tagCn, children: tag }) })
      ] }),
      /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-4 md:gap-5", children: [
        /* @__PURE__ */ jsx34("h3", { className: "font-heading font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0] line-clamp-2 min-h-[2.4em] text-[20px] md:text-[clamp(16px,1.6vw,24px)]", children: title }),
        /* @__PURE__ */ jsx34("p", { className: "text-[14px] leading-[1.32] tracking-[0.01em] text-[#939393] h-[54px] overflow-hidden line-clamp-3", children: description })
      ] })
    ] })
  ] });
  if (href) return /* @__PURE__ */ jsx34(Link3, { href, className: rootCn, children: inner });
  return /* @__PURE__ */ jsx34("div", { className: rootCn, children: inner });
}
            ...
            children: items.map((item, i) => {
              ...
              return /* @__PURE__ */ jsxs17(
                "li",
                {
                  ...
                  children: [
                    item.href && !isLast ? /* @__PURE__ */ jsx35(
                      "a",
                      {
                        href: item.href,
...
function Tag(props) {
  ...
  if (as === "a") {
    return /* @__PURE__ */ jsx36("a", { ...rest, className: classes });
  }
  return /* @__PURE__ */ jsx36("span", { ...rest, className: classes });
}
...
function Author({
  ...
  if (variant === "short") {
    return /* @__PURE__ */ jsxs18(
      "div",
      {
        ...
        ...props,
        children: [
          showAvatar && /* @__PURE__ */ jsxs18(Avatar, { size: "xs", className: "shrink-0 border-0", children: [
            avatarUrl ? /* @__PURE__ */ jsx37(AvatarImage, { src: avatarUrl, alt: name }) : null,
            /* @__PURE__ */ jsx37(AvatarFallback, { className: "text-[10px]", children: initials })
          ] }),
          /* @__PURE__ */ jsx37("span", { className: "min-w-0 flex-1 truncate font-[family-name:var(--font-mono-family)] font-medium uppercase tracking-[0.02em] leading-[1.16] text-[color:var(--rm-gray-fg-sub)]", children: name }),
          formatted && /* @__PURE__ */ jsxs18(Fragment4, { children: [
            /* @__PURE__ */ jsx37("span", { className: "mx-1 h-3 w-px shrink-0 bg-[color:var(--rm-gray-3)]", "aria-hidden": true }),
            /* @__PURE__ */ jsxs18("span", { className: "inline-flex shrink-0 items-center gap-1 whitespace-nowrap text-[color:var(--rm-gray-fg-sub)] leading-[1.32] tracking-[0.01em]", children: [
              /* @__PURE__ */ jsx37(Calendar, { className: "h-4 w-4", strokeWidth: 1.5, "aria-hidden": true }),
              formatted
            ] })
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxs18(
    "div",
    {
      ...
      ...props,
      children: [
        showAvatar && /* @__PURE__ */ jsxs18(Avatar, { size: "md", className: "shrink-0 border-0", children: [
          avatarUrl ? /* @__PURE__ */ jsx37(AvatarImage, { src: avatarUrl, alt: name }) : null,
          /* @__PURE__ */ jsx37(AvatarFallback, { className: "text-[length:var(--text-12)]", children: initials })
        ] }),
        /* @__PURE__ */ jsxs18("div", { className: "flex flex-col justify-center gap-1 min-w-0 flex-1", children: [
          /* @__PURE__ */ jsx37("span", { className: "font-[family-name:var(--font-mono-family)] font-medium uppercase tracking-[0.02em] leading-[1.16] text-[color:var(--rm-gray-fg-main)] truncate", children: name }),
          formatted && /* @__PURE__ */ jsxs18("span", { className: "inline-flex items-center gap-1 text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[color:var(--rm-gray-fg-sub)]", children: [
            /* @__PURE__ */ jsx37(Calendar, { className: "h-4 w-4", strokeWidth: 1.5, "aria-hidden": true }),
            formatted
          ] })
        ] })
...
function KeyThoughts({ thoughts, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx38(
    "ul",
    {
      ...
      ...props,
      children: thoughts.map((t, i) => /* @__PURE__ */ jsx38(
        "li",
        {
...
function ArticleNav({
  ...
  return /* @__PURE__ */ jsx39(
    "nav",
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx39("ul", { className: "flex flex-col gap-5", children: items.map((item) => {
        const isActive = item.active ?? item.id === activeId;
        const hasChildren = isActive && item.children && item.children.length > 0;
        return /* @__PURE__ */ jsxs19("li", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx39(
            NavLink,
            {
              item,
          ...
          hasChildren && /* @__PURE__ */ jsx39("ul", { className: "flex flex-col gap-3 pl-4 border-l border-[color:var(--rm-gray-3)]", children: item.children.map((child) => {
...
function ArticlePagination({
  ...
  const renderButton = (link, direction) => {
    ...
    const content = direction === "prev" ? /* @__PURE__ */ jsxs20(Fragment5, { children: [
      /* @__PURE__ */ jsx40(ArrowLeft, { className: ICON_CLASS, strokeWidth: 1.5 }),
      /* @__PURE__ */ jsx40("span", { className: LABEL_CLASS, children: link.label })
    ] }) : /* @__PURE__ */ jsxs20(Fragment5, { children: [
      /* @__PURE__ */ jsx40("span", { className: LABEL_CLASS, children: link.label }),
      /* @__PURE__ */ jsx40(ArrowRight, { className: ICON_CLASS, strokeWidth: 1.5 })
    ] });
    ...
    return /* @__PURE__ */ jsx40("a", { href: link.href, className: className2, "aria-label": ariaLabel, children: content });
  };
...
function ArticleCard({
  ...
  return /* @__PURE__ */ jsxs21(
    "article",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx41("div", { className: "hidden md:block", children: /* @__PURE__ */ jsx41(
          GlowingEffect,
          {
            spread: 40,
            glow: false,
        ...
        href && /* @__PURE__ */ jsxs21(Fragment6, { children: [
          /* @__PURE__ */ jsx41(
            "a",
            {
              href,
          ...
          /* @__PURE__ */ jsx41(
            "div",
            {
              ...
              "aria-hidden": true,
              children: /* @__PURE__ */ jsx41("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx41(
                "path",
                {
                  d: "M1 10L10 1M10 1H3M10 1V8",
                  stroke: "currentColor",
        ...
        variant === "wide" ? /* @__PURE__ */ jsxs21(Fragment6, { children: [
          /* @__PURE__ */ jsx41("div", { className: "sm:hidden", children: /* @__PURE__ */ jsx41(
            DefaultLayout,
            {
              coverUrl,
              visibleTags,
          ...
          /* @__PURE__ */ jsx41("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsx41(
            WideLayout,
            {
              coverUrl,
              visibleTags,
        ...
        /* @__PURE__ */ jsxs21("div", { className: "relative z-[1] mt-7 flex flex-1 flex-col gap-5", children: [
          /* @__PURE__ */ jsxs21("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsx41(
              "h3",
              {
                ref: titleRef,
...
function DefaultLayout({
  ...
  return /* @__PURE__ */ jsx41(Fragment6, { children: /* @__PURE__ */ jsxs21("div", { className: "relative aspect-[3/2] w-full overflow-hidden rounded-sm", children: [
    coverUrl ? (
    ...
    (visibleTags.length > 0 || typeBadge) && /* @__PURE__ */ jsxs21("div", { className: "absolute inset-x-0 bottom-3 z-[1] flex flex-wrap-reverse gap-x-2 gap-y-1", children: [
      typeBadge && /* @__PURE__ */ jsx41(TypeBadge, { badge: typeBadge }),
      visibleTags.map((t) => /* @__PURE__ */ jsx41(Tag, { size: "s", children: t }, t))
    ] })
  ] }) });
}
function WideLayout({
  ...
  return /* @__PURE__ */ jsxs21("div", { className: "relative z-[0] flex gap-6", children: [
    /* @__PURE__ */ jsx41("div", { className: "relative aspect-[4/3] flex-[3] overflow-hidden rounded-sm", children: coverUrl ? (
      // eslint-disable-next-line @next/next/no-img-element
      /* @__PURE__ */ jsx41(
        "img",
        {
    ...
    /* @__PURE__ */ jsxs21("div", { className: "flex flex-[2] flex-col justify-between gap-4", children: [
      (visibleTags.length > 0 || typeBadge) && /* @__PURE__ */ jsxs21("div", { className: "flex flex-col items-start gap-1.5", children: [
        typeBadge && /* @__PURE__ */ jsx41(TypeBadge, { badge: typeBadge }),
        visibleTags.map((t) => /* @__PURE__ */ jsx41(Tag, { size: "s", children: t }, t))
      ] }),
      authorName && /* @__PURE__ */ jsx41(
...
import { Fragment as Fragment7, jsx as jsx42, jsxs as jsxs22 } from "react/jsx-runtime";
...
function GlossaryWidget({
  ...
  const headContent = /* @__PURE__ */ jsxs22(Fragment7, { children: [
    /* @__PURE__ */ jsxs22(
      "a",
      {
        href: fullPageHref,
        ...
        children: [
          /* @__PURE__ */ jsx42("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase tracking-[-0.01em] leading-[1.16] text-[color:var(--rm-gray-fg-main)]", children: heading }),
          /* @__PURE__ */ jsx42("span", { className: "inline-flex h-8 w-8 items-center justify-center rounded-[4px] text-[#404040] transition-colors group-hover/widget:text-[#F0F0F0]", children: /* @__PURE__ */ jsx42("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx42(
            "path",
            {
              d: "M1 10L10 1M10 1H3M10 1V8",
              stroke: "currentColor",
    ...
    /* @__PURE__ */ jsxs22("label", { className: "flex items-center gap-2 rounded-sm border border-[color:var(--rm-gray-3)] bg-transparent px-3 py-2 focus-within:border-[color:var(--rm-yellow-100)]", children: [
      /* @__PURE__ */ jsx42(
        Search2,
        {
  ...
  const groupsList = /* @__PURE__ */ jsxs22("div", { className: "flex flex-col gap-5", children: [
    groups.length === 0 && /* @__PURE__ */ jsx42("p", { className: "py-2 text-[length:var(--text-14)] text-[color:var(--rm-gray-fg-sub)]", children: "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0448\u043B\u043E\u0441\u044C." }),
    groups.map((g) => /* @__PURE__ */ jsx42(LetterGroupBlock, { group: g }, g.letter))
  ] });
  if (stickyTop !== void 0) {
  ...
  return /* @__PURE__ */ jsxs22(
    "aside",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs22("div", { className: "absolute inset-0 flex flex-col", children: [
          /* @__PURE__ */ jsxs22("div", { className: "sticky z-20", style: { top: stickyTop }, children: [
            /* @__PURE__ */ jsx42("div", { className: "flex flex-col gap-5 rounded-t-sm bg-[color:var(--rm-gray-1)] px-6 pt-6 pb-5", children: head }),
            /* @__PURE__ */ jsx42(
              "div",
              {
                "aria-hidden": true,
...
function LetterGroupBlock({ group }) {
  return /* @__PURE__ */ jsxs22("div", { className: "flex flex-col gap-2", children: [
    /* @__PURE__ */ jsx42("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-18)] font-bold uppercase tracking-[-0.01em] leading-[1.2] text-[color:var(--rm-yellow-100)]", children: group.letter }),
    /* @__PURE__ */ jsx42("ul", { className: "flex flex-col gap-1.5", children: group.items.map((item) => /* @__PURE__ */ jsx42("li", { children: /* @__PURE__ */ jsx42(
      "a",
      {
        href: item.href,
...
function GlossaryList({
  ...
  const groups = React14.useMemo(() => groupByLetter(filtered), [filtered]);
  if (groups.length === 0) {
    return /* @__PURE__ */ jsx42("p", { className: cn("py-16 text-center text-[length:var(--text-14)] text-[color:var(--rm-gray-fg-sub)]", className), children: "\u041F\u043E \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u043C \u0444\u0438\u043B\u044C\u0442\u0440\u0430\u043C \u0442\u0435\u0440\u043C\u0438\u043D\u043E\u0432 \u043D\u0435\u0442." });
  }
  return /* @__PURE__ */ jsx42(
    "div",
    {
      ...
      ...props,
      children: groups.map((g) => /* @__PURE__ */ jsx42("div", { className: "mb-10 break-inside-avoid", children: /* @__PURE__ */ jsx42(LetterGroupBlock, { group: g }) }, g.letter))
    }
  );
}
function GlossaryPopularRow({
  ...
  return /* @__PURE__ */ jsxs22("div", { className: cn("relative", className), ...props, children: [
    /* @__PURE__ */ jsx42(
      "div",
      {
        ref: scrollRef,
        ...
        children: /* @__PURE__ */ jsx42("div", { className: "flex w-max gap-3 pr-10", children: items.map((it) => /* @__PURE__ */ jsxs22(
          "a",
          {
            href: it.href,
            className: cn(
            ...
            children: [
              /* @__PURE__ */ jsx42("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-16)] font-bold uppercase tracking-[-0.01em] leading-[1.16] text-[color:var(--rm-gray-fg-main)] line-clamp-2", children: it.title }),
              it.description && /* @__PURE__ */ jsx42("span", { className: "text-[length:var(--text-12)] leading-[1.35] text-[color:var(--rm-gray-fg-sub)] line-clamp-3", children: it.description })
            ]
          },
          it.slug
        )) })
  ...
  return /* @__PURE__ */ jsxs23(
    "div",
    {
      ...
      children: [
        ...
        !isPlaying && !isBuffering && !hasError && /* @__PURE__ */ jsx43(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsx43(Play, { className: "h-6 w-6 translate-x-[1px]", fill: "currentColor" })
          }
        ),
        isBuffering && !hasError && /* @__PURE__ */ jsx43("div", { className: "pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx43(Loader2, { className: "h-10 w-10 animate-spin text-[#F0F0F0]/90" }) }),
        hasError && /* @__PURE__ */ jsx43("div", { className: "absolute inset-0 flex items-center justify-center bg-black/60 px-6 text-center", children: /* @__PURE__ */ jsx43("p", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-12)] uppercase tracking-[0.02em] text-[#F0F0F0]", children: "\u0412\u0438\u0434\u0435\u043E \u043D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C" }) }),
        /* @__PURE__ */ jsxs23(
          "div",
          {
            className: cn(
            ...
            children: [
              /* @__PURE__ */ jsxs23(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs23("div", { className: "relative h-[3px] w-full overflow-hidden rounded-full bg-white/20 transition-[height] duration-[var(--duration-fast)] ease-[var(--ease-standard)] group-hover/bar:h-[5px] data-[scrub=true]:h-[5px]", "data-scrub": isScrubbing, children: [
                      /* @__PURE__ */ jsx43(
                        "div",
                        {
              ...
              /* @__PURE__ */ jsxs23("div", { className: "pointer-events-auto flex items-center gap-2 md:gap-3", children: [
                /* @__PURE__ */ jsx43(ControlButton, { onClick: togglePlay, label: isPlaying ? "\u041F\u0430\u0443\u0437\u0430" : "\u0412\u043E\u0441\u043F\u0440\u043E\u0438\u0437\u0432\u0435\u0441\u0442\u0438", children: isPlaying ? /* @__PURE__ */ jsx43(Pause, { className: "h-4 w-4 md:h-5 md:w-5", fill: "currentColor" }) : /* @__PURE__ */ jsx43(Play, { className: "h-4 w-4 translate-x-[1px] md:h-5 md:w-5", fill: "currentColor" }) }),
                /* @__PURE__ */ jsxs23("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-11)] uppercase tracking-[0.02em] text-[#F0F0F0] md:text-[length:var(--text-12)]", children: [
                  formatTime(currentTime),
                  /* @__PURE__ */ jsx43("span", { className: "mx-1 text-[#F0F0F0]/50", children: "/" }),
                  formatTime(duration)
                ] }),
                /* @__PURE__ */ jsxs23("div", { className: "ml-auto flex items-center gap-2 md:gap-3", children: [
                  /* @__PURE__ */ jsxs23("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsx43(ControlButton, { onClick: toggleMute, label: isMuted ? "\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0437\u0432\u0443\u043A" : "\u0412\u044B\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0437\u0432\u0443\u043A", children: isMuted || volume === 0 ? /* @__PURE__ */ jsx43(VolumeX, { className: "h-4 w-4 md:h-5 md:w-5" }) : /* @__PURE__ */ jsx43(Volume2, { className: "h-4 w-4 md:h-5 md:w-5" }) }),
                    /* @__PURE__ */ jsxs23(
                      "div",
                      {
                        ref: volumeRef,
                        ...
                        children: [
                          /* @__PURE__ */ jsx43("div", { className: "relative h-[3px] w-full overflow-hidden rounded-full bg-white/20", children: /* @__PURE__ */ jsx43(
                            "div",
                            {
                  ...
                  /* @__PURE__ */ jsx43(
                    ControlButton,
                    {
                      ...
                      children: isFullscreen ? /* @__PURE__ */ jsx43(Minimize, { className: "h-4 w-4 md:h-5 md:w-5" }) : /* @__PURE__ */ jsx43(Maximize, { className: "h-4 w-4 md:h-5 md:w-5" })
                    }
                  )
                ] })
              ] })
...
import { Fragment as Fragment9, jsx as jsx44, jsxs as jsxs24 } from "react/jsx-runtime";
var RU_MAP = {
  \u0430: "a",
  \u0431: "b",
  \u0432: "v",
...
function renderInline(text, glossary, slugLookup) {
  ...
  while ((match = re.exec(text)) !== null) {
    ...
    if (url.startsWith(GLOSSARY_URL_PREFIX)) {
      ...
      if (entry) {
        nodes.push(
          /* @__PURE__ */ jsx44(GlossaryLink, { entry, matched: label }, `gm-${match.index}`)
        );
      } else {
        nodes.push(
          /* @__PURE__ */ jsx44(React16.Fragment, { children: label }, `gm-${match.index}`)
        );
      }
    } else {
      nodes.push(
...
function pushPlain(nodes, text, keyPrefix, glossary, used) {
  ...
  const parts = applyGlossaryLinks(
    ...
    glossary,
    used,
    (entry, matched, key) => /* @__PURE__ */ jsx44(GlossaryLink, { entry, matched }, key),
    keyPrefix
  );
  ...
  return /* @__PURE__ */ jsxs24(Tooltip, { children: [
    ...
    /* @__PURE__ */ jsxs24(
      TooltipContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsx44("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-11)] uppercase tracking-[0.04em] opacity-70", children: entry.title }),
          entry.description && /* @__PURE__ */ jsx44("span", { className: "text-[length:var(--text-13)]", children: entry.description }),
          /* @__PURE__ */ jsxs24(
            "a",
            {
              href: `/media/glossary/term/${entry.slug}`,
              ...
              children: [
                "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u0432 \u0433\u043B\u043E\u0441\u0441\u0430\u0440\u0438\u0438",
                /* @__PURE__ */ jsx44(ArrowUpRight, { className: "size-3.5", strokeWidth: 2.25, "aria-hidden": true })
              ]
            }
          )
        ]
...
function renderLineBreaks(text, keyPrefix) {
  ...
  if (parts.length === 1) return /* @__PURE__ */ jsx44(React16.Fragment, { children: text }, keyPrefix);
  return /* @__PURE__ */ jsx44(React16.Fragment, { children: parts.map((p, i) => /* @__PURE__ */ jsxs24(React16.Fragment, { children: [
    i > 0 && /* @__PURE__ */ jsx44("br", {}),
    p
...
function Image2({
  ...
  return /* @__PURE__ */ jsxs24("figure", { className: cn("flex flex-col gap-3", className), children: [
    /* @__PURE__ */ jsx44(
      "img",
      {
        src,
    ...
    caption && /* @__PURE__ */ jsx44("figcaption", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-12)] uppercase tracking-[0.02em] text-[color:var(--rm-gray-fg-sub)]", children: caption })
  ] });
}
function Gallery({
  items,
  ...
  return /* @__PURE__ */ jsxs24("div", { className: cn("flex flex-col gap-2", className), children: [
    /* @__PURE__ */ jsx44(
      "div",
      {
    ...
    /* @__PURE__ */ jsx44(
      "div",
      {
        ...
        children: active.kind === "video" ? (
          ...
          /* @__PURE__ */ jsx44(VideoPlayer, { src: active.src }, active.id)
    ...
    active.caption && active.caption.trim() && /* @__PURE__ */ jsx44(
      "figcaption",
      {
...
function Video({
  ...
  return /* @__PURE__ */ jsxs24("figure", { className: cn("flex flex-col gap-3", className), children: [
    /* @__PURE__ */ jsx44(VideoPlayer, { src, poster }),
    caption && /* @__PURE__ */ jsx44("figcaption", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-12)] uppercase tracking-[0.02em] text-[color:var(--rm-gray-fg-sub)]", children: caption })
  ] });
}
function Table2({
  ...
  return /* @__PURE__ */ jsxs24("div", { className: cn("relative", className), children: [
    /* @__PURE__ */ jsx44(
      "div",
      {
        ref: scrollRef,
        ...
        children: /* @__PURE__ */ jsx44(
          "div",
          {
            ...
            children: grid.map((row, ri) => {
              ...
              return /* @__PURE__ */ jsxs24(React16.Fragment, { children: [
                ri > 0 && /* @__PURE__ */ jsx44(
                  "div",
                  {
                    "aria-hidden": true,
                ...
                row.map((cell, ci) => /* @__PURE__ */ jsx44(
                  "div",
                  {
                    className: cn(
      ...
      children: cards.map((card, i) => {
        ...
        return /* @__PURE__ */ jsxs24(
          "div",
          {
            ...
            children: [
              card.title.trim() && /* @__PURE__ */ jsx44(
                "h4",
                {
                  className: cn(
              ...
              visibleItems.length > 0 && /* @__PURE__ */ jsx44("ul", { className: "flex flex-col gap-2", children: visibleItems.map((item, idx) => /* @__PURE__ */ jsxs24("li", { className: "flex items-start gap-5", children: [
                type === "bullet" ? /* @__PURE__ */ jsx44(
                  "span",
                  {
                    "aria-hidden": true,
                ...
                /* @__PURE__ */ jsx44("span", { className: "text-[length:var(--text-16)] leading-[1.28] text-[color:var(--rm-gray-fg-sub)]", children: item.text })
              ] }, item.id)) })
            ]
          },
          card.id
...
function ArticleBody({
  ...
  return /* @__PURE__ */ jsx44("div", { className: cn("flex flex-col items-stretch", className), ...props, children: blocks.map((block, i) => {
    ...
    if (block.type === "gallery") {
      ...
      if (items.length === 0) return null;
      return /* @__PURE__ */ jsx44(Gallery, { items, className: mt }, block.id);
    }
    if (block.type === "table") {
    ...
    switch (block.type) {
      case "h2":
        return /* @__PURE__ */ jsx44(H2, { text, className: mt }, block.id);
      case "h3":
        return /* @__PURE__ */ jsx44(H3, { text, className: mt }, block.id);
      case "h4":
        return /* @__PURE__ */ jsx44(H4, { text, className: mt }, block.id);
      case "paragraph":
        return /* @__PURE__ */ jsx44(
          Paragraph,
          {
  ...
  return /* @__PURE__ */ jsxs25(
    "div",
    {
      ...
      children: [
        ...
        visibleParagraphs.length > 0 && /* @__PURE__ */ jsx45("div", { className: "flex flex-col gap-4", children: visibleParagraphs.map((p, i) => /* @__PURE__ */ jsx45(
          "p",
          {
...
function QuoteAuthor({
  ...
  return /* @__PURE__ */ jsxs25(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs25("div", { className: cn("flex items-center", gap), children: [
          avatarUrl ? (
            // eslint-disable-next-line @next/next/no-img-element
            /* @__PURE__ */ jsx45(
              "img",
        ...
        role && /* @__PURE__ */ jsx45("p", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: role })
      ]
    }
  );
}
function QuoteRow({
  ...
  if (variant === "wide") {
    return /* @__PURE__ */ jsxs25("div", { className: "grid grid-cols-[2fr_1fr]", children: [
      /* @__PURE__ */ jsx45(
        QuoteText,
        {
          label: quote.label,
      ...
      /* @__PURE__ */ jsx45("div", { className: "border-l border-[#404040]", children: /* @__PURE__ */ jsx45(
        QuoteAuthor,
        {
          name: quote.name,
          role: quote.role,
  ...
  if (variant === "mobile") {
    return /* @__PURE__ */ jsxs25("div", { className: "flex flex-col", children: [
      ...
      /* @__PURE__ */ jsx45("div", { className: "h-px bg-[#404040]" }),
      /* @__PURE__ */ jsx45(
        QuoteAuthor,
        {
          name: quote.name,
...
function ExpertQuoteStack({
  ...
  return /* @__PURE__ */ jsx45(
    "div",
    {
      ...
      "data-variant": variant,
      children: quotes.map((q, i) => /* @__PURE__ */ jsxs25(React17.Fragment, { children: [
        i > 0 && /* @__PURE__ */ jsx45("div", { className: "h-px bg-[#404040]" }),
        /* @__PURE__ */ jsx45(QuoteRow, { quote: q, variant })
      ] }, q.id))
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxs26(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx46("span", { className: "line-clamp-1 font-[family-name:var(--font-mono-family)] font-medium uppercase tracking-[0.02em] text-[length:var(--text-14)] leading-[1.2] transition-colors group-hover/chip:text-[color:var(--rm-yellow-100)]", children: title }),
              /* @__PURE__ */ jsx46(
                ArrowUpRight2,
                {
                  "aria-hidden": true,
        ...
        hasPreview && /* @__PURE__ */ jsx46("div", { className: "relative w-full overflow-hidden", children: /* @__PURE__ */ jsx46("div", { style: { aspectRatio: "3 / 2" }, children: /* @__PURE__ */ jsx46(
          "img",
          {
            src: previewImageUrl,
            alt: "",
  ...
  return /* @__PURE__ */ jsxs27(
    "a",
    {
      ...
      children: [
        ...
        variant === "image" && coverUrl && /* @__PURE__ */ jsxs27("div", { className: "relative w-full overflow-hidden rounded-sm aspect-[286/191]", children: [
          /* @__PURE__ */ jsx47(
            "img",
            {
              src: coverUrl,
        ...
        variant === "default" && (coverUrl || list.length > 0) && /* @__PURE__ */ jsxs27("div", { className: "flex items-center gap-2", children: [
          coverUrl && /* @__PURE__ */ jsx47("div", { className: "h-[72px] w-[72px] shrink-0 overflow-hidden rounded-sm", children: /* @__PURE__ */ jsx47(
            "img",
            {
              src: coverUrl,
              alt: "",
          ...
          list.length > 0 && /* @__PURE__ */ jsxs27("div", { className: "flex items-center -space-x-2", children: [
            shown.map((ex, i) => /* @__PURE__ */ jsx47(Avatar2, { name: ex.name, image: ex.image }, i)),
            extra > 0 && /* @__PURE__ */ jsxs27(
              "span",
              {
        ...
        /* @__PURE__ */ jsxs27(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx47("h3", { className: "line-clamp-3 pr-6 font-[family-name:var(--font-heading-family)] font-bold uppercase text-[length:var(--text-18)] leading-[1.16] tracking-[-0.01em]", children: title }),
              description && /* @__PURE__ */ jsx47("p", { className: "line-clamp-3 text-[length:var(--text-12)] leading-[1.35] text-[color:var(--rm-gray-fg-sub)]", children: description })
            ]
          }
        )
      ]
...
function Avatar2({ name, image }) {
  ...
  return /* @__PURE__ */ jsx47("span", { className: "flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#0A0A0A] bg-[#333333] text-[length:var(--text-18)] font-medium text-[color:var(--rm-gray-fg-main)]", children: initials });
}

// src/components/ui/for-whom-section.tsx
import { Fragment as Fragment11, jsx as jsx48, jsxs as jsxs28 } from "react/jsx-runtime";
function FactCard({ title, text }) {
  return /* @__PURE__ */ jsxs28("div", { className: "grid grid-rows-[subgrid] row-span-3 gap-4", children: [
    /* @__PURE__ */ jsx48("div", { className: "flex items-end", children: /* @__PURE__ */ jsx48("h4", { className: "h4 text-[#0A0A0A]", children: title }) }),
    /* @__PURE__ */ jsx48("div", { className: "h-0 w-full border-t border-[#404040]" }),
...
function ForWhomSection({
  ...
  return /* @__PURE__ */ jsxs28("section", { className: cn("w-full bg-[#F0F0F0] py-10 md:py-16 lg:py-20", className), children: [
    /* @__PURE__ */ jsxs28("div", { className: "hidden lg:flex flex-col gap-[104px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
      /* @__PURE__ */ jsxs28("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx48("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ jsxs28("div", { className: "flex", children: [
          /* @__PURE__ */ jsx48("div", { className: "w-1/2 shrink-0 pr-8", children: /* @__PURE__ */ jsxs28("h2", { className: "h2", children: [
            /* @__PURE__ */ jsx48("span", { className: "text-[#0A0A0A]", children: title }),
            titleSecondary ? /* @__PURE__ */ jsxs28(Fragment11, { children: [
              /* @__PURE__ */ jsx48("span", { className: "text-[#0A0A0A]", children: " " }),
              /* @__PURE__ */ jsx48("span", { className: "text-[#666666]", children: titleSecondary })
            ] }) : null
          ] }) }),
          hasParagraphs && /* @__PURE__ */ jsx48("div", { className: "w-1/2", children: /* @__PURE__ */ jsx48("div", { className: "max-w-[480px]", children: /* @__PURE__ */ jsx48(StyledParagraphs, { paragraphs: resolvedParagraphsDesktop, theme: "light", size: "18" }) }) })
        ] })
      ] }),
      (() => {
        let leftFacts;
        ...
        const renderCard = (f, i) => /* @__PURE__ */ jsxs28("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsx48("div", { className: "flex items-end", children: /* @__PURE__ */ jsx48("h4", { className: "h4 text-[#0A0A0A]", children: f.title }) }),
          /* @__PURE__ */ jsx48("div", { className: "h-0 w-full border-t border-[#404040]" }),
          /* @__PURE__ */ jsx48(
            RichText,
            {
        ...
        return /* @__PURE__ */ jsxs28("div", { className: "flex", children: [
          /* @__PURE__ */ jsx48("div", { className: "w-1/2 flex gap-4 pr-4", children: leftFacts.map((f, i) => /* @__PURE__ */ jsx48("div", { className: "flex-1", children: renderCard(f, i) }, i)) }),
          /* @__PURE__ */ jsx48("div", { className: "w-1/2 flex gap-4", children: rightFacts.map((f, i) => /* @__PURE__ */ jsx48("div", { className: "flex-1", children: renderCard(f, i) }, i)) })
        ] });
      })()
    ] }),
    /* @__PURE__ */ jsxs28("div", { className: "flex lg:hidden flex-col gap-16 px-5 md:px-8", children: [
      /* @__PURE__ */ jsxs28("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx48("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        ...
        hasParagraphs && /* @__PURE__ */ jsx48("div", { className: "mt-1", children: /* @__PURE__ */ jsx48(StyledParagraphs, { paragraphs: resolvedParagraphsDesktop, theme: "light", size: "16" }) })
      ] }),
      /* @__PURE__ */ jsx48("div", { className: "flex flex-col gap-7", children: facts.map((f, i) => /* @__PURE__ */ jsx48("div", { className: "grid", style: { gridTemplateRows: "auto auto 1fr" }, children: /* @__PURE__ */ jsx48(FactCard, { ...f }) }, i)) })
    ] })
  ] });
}
...
// src/components/ui/contacts-section.tsx
import { Fragment as Fragment13, jsx as jsx52, jsxs as jsxs30 } from "react/jsx-runtime";
function SocialIcon({
  kind,
  iconSrc,
  className
}) {
  if (kind === "vk") return /* @__PURE__ */ jsx52(VkIcon, { className });
  if (kind === "telegram") return /* @__PURE__ */ jsx52(TelegramIcon, { className });
  if (kind === "max") return /* @__PURE__ */ jsx52(MaxIcon, { className });
  ...
  return /* @__PURE__ */ jsx52(
    "span",
    {
      ...
      children: /* @__PURE__ */ jsx52("img", { src: iconSrc, alt: "", className: "h-5 w-5 object-contain" })
    }
  );
}
...
function SocialsItem({ socials }) {
  ...
  return /* @__PURE__ */ jsx52(TooltipProvider, { delay: 150, children: /* @__PURE__ */ jsx52("div", { className: "flex flex-wrap items-center gap-5 text-[#0A0A0A]", children: socials.map((s) => {
    const label = socialTooltipText(s);
    const icon = /* @__PURE__ */ jsx52(
      SocialIcon,
      {
        kind: s.kind,
        iconSrc: s.iconSrc,
    ...
    const trigger = s.url ? /* @__PURE__ */ jsx52(
      "a",
      {
        href: s.url,
        target: "_blank",
    ...
    ) : /* @__PURE__ */ jsx52("span", { "aria-label": label || s.username, className: "group/social inline-flex", children: icon });
    if (!label) return /* @__PURE__ */ jsx52(React20.Fragment, { children: trigger }, s.id);
    return /* @__PURE__ */ jsxs30(Tooltip, { children: [
      /* @__PURE__ */ jsx52(TooltipTrigger, { render: trigger }),
      /* @__PURE__ */ jsx52(TooltipContent, { children: label })
    ] }, s.id);
  }) }) });
}
function PersonItem({ person }) {
  const socialLabel = person.social ? socialTooltipText(person.social) : "";
  return /* @__PURE__ */ jsxs30("div", { className: "flex items-start gap-4", children: [
    /* @__PURE__ */ jsx52(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs30("div", { className: "flex min-w-0 flex-1 flex-col gap-1", children: [
      /* @__PURE__ */ jsx52("div", { className: "text-[length:var(--text-16)] font-medium leading-[1.28] text-[#0A0A0A]", children: person.name }),
      person.role ? /* @__PURE__ */ jsx52("div", { className: "text-[length:var(--text-14)] leading-[1.32] text-[#404040]", children: person.role }) : null,
      person.phone ? /* @__PURE__ */ jsx52(
        "a",
        {
      ...
      person.social && (person.social.url || person.social.username) ? /* @__PURE__ */ jsx52("div", { className: "inline-flex items-center gap-1.5 text-[#0A0A0A]", children: person.social.url ? /* @__PURE__ */ jsxs30(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx52(SocialIcon, { kind: person.social.kind, iconSrc: person.social.iconSrc, className: "h-4 w-4" }),
            socialLabel && /* @__PURE__ */ jsx52("span", { children: socialLabel })
          ]
        }
      ) : /* @__PURE__ */ jsxs30("span", { className: "inline-flex items-center gap-1.5 text-[length:var(--text-14)] leading-[1.32]", children: [
        /* @__PURE__ */ jsx52(SocialIcon, { kind: person.social.kind, iconSrc: person.social.iconSrc, className: "h-4 w-4" }),
        socialLabel && /* @__PURE__ */ jsx52("span", { children: socialLabel })
      ] }) }) : null
    ] })
...
function CardItemRenderer({ item }) {
  if (item.kind === "paragraph") return /* @__PURE__ */ jsx52(ParagraphItem, { paragraph: item.paragraph });
  if (item.kind === "socials") return /* @__PURE__ */ jsx52(SocialsItem, { socials: item.socials });
  return /* @__PURE__ */ jsx52(PersonItem, { person: item.person });
}
function ContactCardView({ card }) {
  return /* @__PURE__ */ jsxs30("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx52("div", { className: "flex items-end", children: /* @__PURE__ */ jsx52("h4", { className: "h4 text-[#0A0A0A]", children: card.title }) }),
    /* @__PURE__ */ jsx52("div", { className: "h-0 w-full border-t border-[#404040]" }),
    /* @__PURE__ */ jsx52("div", { className: "flex flex-col gap-4", children: card.items.map((item) => /* @__PURE__ */ jsx52(CardItemRenderer, { item }, item.id)) })
  ] });
}
function ContactsSection({
  ...
  return /* @__PURE__ */ jsxs30("section", { className: cn("w-full bg-[#F0F0F0] py-10 md:py-16 lg:py-20", className), children: [
    /* @__PURE__ */ jsxs30("div", { className: "hidden lg:flex flex-col gap-[104px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
      /* @__PURE__ */ jsxs30("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx52("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ jsxs30("div", { className: "flex", children: [
          /* @__PURE__ */ jsx52("div", { className: "w-1/2 shrink-0 pr-8", children: /* @__PURE__ */ jsxs30("h2", { className: "h2", children: [
            /* @__PURE__ */ jsx52("span", { className: "text-[#0A0A0A]", children: title }),
            titleSecondary ? /* @__PURE__ */ jsxs30(Fragment13, { children: [
              /* @__PURE__ */ jsx52("span", { className: "text-[#0A0A0A]", children: " " }),
              /* @__PURE__ */ jsx52("span", { className: "text-[#666666]", children: titleSecondary })
            ] }) : null
          ] }) }),
          hasParagraphs && /* @__PURE__ */ jsx52("div", { className: "w-1/2", children: /* @__PURE__ */ jsx52("div", { className: "max-w-[480px]", children: /* @__PURE__ */ jsx52(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "light", size: "18" }) }) })
        ] })
      ] }),
      cards.length > 0 && /* @__PURE__ */ jsxs30("div", { className: "flex", children: [
        /* @__PURE__ */ jsx52("div", { className: "w-1/2 flex gap-4 pr-4", children: leftCards.map((card) => /* @__PURE__ */ jsx52("div", { className: "flex-1", children: /* @__PURE__ */ jsx52(ContactCardView, { card }) }, card.id)) }),
        /* @__PURE__ */ jsx52("div", { className: "w-1/2 flex gap-4", children: rightCards.map((card) => /* @__PURE__ */ jsx52("div", { className: "flex-1", children: /* @__PURE__ */ jsx52(ContactCardView, { card }) }, card.id)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs30("div", { className: "flex lg:hidden flex-col gap-16 px-5 md:px-8", children: [
      /* @__PURE__ */ jsxs30("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx52("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ jsxs30("h2", { className: "h3", children: [
          /* @__PURE__ */ jsx52("span", { className: "text-[#0A0A0A]", children: title }),
          titleSecondary ? /* @__PURE__ */ jsxs30(Fragment13, { children: [
            /* @__PURE__ */ jsx52("span", { className: "text-[#0A0A0A]", children: " " }),
            /* @__PURE__ */ jsx52("span", { className: "text-[#666666]", children: titleSecondary })
        ...
        hasParagraphs && /* @__PURE__ */ jsx52("div", { className: "mt-1", children: /* @__PURE__ */ jsx52(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "light", size: "16" }) })
      ] }),
      /* @__PURE__ */ jsx52("div", { className: "flex flex-col gap-7", children: cards.map((card) => /* @__PURE__ */ jsx52(ContactCardView, { card }, card.id)) })
    ] })
  ] });
}
...
import { Fragment as Fragment14, jsx as jsx53, jsxs as jsxs31 } from "react/jsx-runtime";
function TimelineColumn({
  isActive,
  isLast,
  fillProgress
}) {
  return /* @__PURE__ */ jsxs31("div", { className: "relative w-px shrink-0 self-stretch", children: [
    /* @__PURE__ */ jsx53("div", { className: "absolute inset-0 bg-[#404040]" }),
    /* @__PURE__ */ jsx53(
      "div",
      {
...
function StepCard({
  ...
  return /* @__PURE__ */ jsxs31("div", { className: cn("flex gap-10 max-w-[364px]", className), children: [
    /* @__PURE__ */ jsx53(TimelineColumn, { isActive, isLast, fillProgress }),
    /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-3 pb-16", children: [
      /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx53(
          "span",
          {
      ...
      /* @__PURE__ */ jsx53("div", { style: { color: isActive ? "#939393" : "rgba(147,147,147,0.5)" }, children: /* @__PURE__ */ jsx53(
        RichText,
        {
          text: step.text,
...
function ParticipantsBlock({
  ...
  return /* @__PURE__ */ jsxs31("div", { className: cn("bg-[#121212] rounded p-8 flex flex-col gap-8 max-w-[648px]", className), children: [
    /* @__PURE__ */ jsx53("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
    /* @__PURE__ */ jsx53("div", { className: "flex flex-col gap-5", children: participants.map((p, i) => /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx53("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#F0F0F0]", children: p.role }),
      /* @__PURE__ */ jsx53(
        RichText,
        {
          text: p.text,
...
function AcademyStepCard({
  ...
  return /* @__PURE__ */ jsxs31(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs31("div", { className: "flex items-start gap-6 lg:w-1/2 lg:items-center", children: [
          /* @__PURE__ */ jsx53("span", { className: "flex-1 h4 text-[#F0F0F0]", children: step.title }),
          /* @__PURE__ */ jsx53("span", { className: "w-[100px] shrink-0 text-right lg:text-left lg:order-first font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: step.number })
        ] }),
        /* @__PURE__ */ jsx53("div", { className: "pl-0 lg:w-1/2 lg:pl-4", children: /* @__PURE__ */ jsx53(
          RichText,
          {
            text: step.text,
            className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393]"
...
function ProcessSection({
  ...
  return /* @__PURE__ */ jsxs31(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs31("div", { className: "hidden lg:flex mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
          /* @__PURE__ */ jsxs31("div", { className: "w-1/2 shrink-0 pr-8 flex flex-col", children: [
            /* @__PURE__ */ jsx53("div", { className: "flex-1 pb-10", children: /* @__PURE__ */ jsx53("div", { className: "sticky top-24", children: /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-8 max-w-[560px]", children: [
              /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsx53("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
                /* @__PURE__ */ jsxs31("h2", { className: "h2", children: [
                  /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: title }),
                  titleSecondary ? /* @__PURE__ */ jsxs31(Fragment14, { children: [
                    /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: " " }),
                    /* @__PURE__ */ jsx53("span", { className: "text-[#939393]", children: titleSecondary })
                  ] }) : null
                ] })
              ] }),
              /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx53(RichText, { text: subtitle, className: subtitleClassDesktop }),
                /* @__PURE__ */ jsx53(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" })
              ] })
            ] }) }) }),
            hasParticipants && /* @__PURE__ */ jsx53("div", { className: "max-w-[648px]", children: /* @__PURE__ */ jsx53(ParticipantsBlock, { tag: participantsTag, participants }) })
          ] }),
          /* @__PURE__ */ jsx53("div", { className: "w-1/2 pt-10", children: /* @__PURE__ */ jsx53("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ jsx53(AcademyStepCard, { step, isFirst: i === 0 }, i)) : steps.map((step, i) => /* @__PURE__ */ jsx53("div", { "data-step": true, children: /* @__PURE__ */ jsx53(
            StepCard,
            {
              step,
        ...
        /* @__PURE__ */ jsxs31("div", { className: "hidden md:flex lg:hidden gap-10 px-8", children: [
          /* @__PURE__ */ jsxs31("div", { className: "w-[45%] shrink-0 flex flex-col", children: [
            /* @__PURE__ */ jsx53("div", { className: "flex-1 pb-10", children: /* @__PURE__ */ jsx53("div", { className: "sticky top-24", children: /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsx53("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
                /* @__PURE__ */ jsxs31("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em]", children: [
                  /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: title }),
                  titleSecondary ? /* @__PURE__ */ jsxs31(Fragment14, { children: [
                    /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: " " }),
                    /* @__PURE__ */ jsx53("span", { className: "text-[#939393]", children: titleSecondary })
              ...
              /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx53(RichText, { text: subtitle, className: subtitleClassSmall }),
                /* @__PURE__ */ jsx53(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
              ] })
            ] }) }) }),
            hasParticipants && /* @__PURE__ */ jsx53(
              ParticipantsBlock,
              {
                tag: participantsTag,
                participants,
          ...
          /* @__PURE__ */ jsx53("div", { className: "flex-1 pt-10", children: /* @__PURE__ */ jsx53("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ jsx53(AcademyStepCard, { step, isFirst: i === 0, className: "lg:flex-col lg:items-start" }, i)) : steps.map((step, i) => /* @__PURE__ */ jsx53("div", { "data-step": true, children: /* @__PURE__ */ jsx53(
            StepCard,
            {
              step,
              isActive: i <= activeIndex,
        ...
        /* @__PURE__ */ jsxs31("div", { className: "flex md:hidden flex-col px-5", children: [
          /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-4 mb-10", children: [
            /* @__PURE__ */ jsxs31("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsx53("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ jsxs31("h2", { className: "h3", children: [
                /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ jsxs31(Fragment14, { children: [
                  /* @__PURE__ */ jsx53("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ jsx53("span", { className: "text-[#939393]", children: titleSecondary })
          ...
          /* @__PURE__ */ jsx53("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ jsx53(AcademyStepCard, { step, isFirst: i === 0 }, i)) : steps.map((step, i) => /* @__PURE__ */ jsx53("div", { "data-step": true, children: /* @__PURE__ */ jsx53(
            StepCard,
            {
              step,
              isActive: i <= activeIndex,
          ...
          hasParticipants && /* @__PURE__ */ jsx53("div", { className: "mt-4", children: /* @__PURE__ */ jsx53(ParticipantsBlock, { tag: participantsTag, participants }) })
        ] })
      ]
    }
  );
...
import { Fragment as Fragment15, jsx as jsx54, jsxs as jsxs32 } from "react/jsx-runtime";
var STEP_OFFSET = 88;
var STAGGER = 0.18;
...
function ResultsSection({
  ...
  return /* @__PURE__ */ jsxs32(
    "section",
    {
      ...
      className: cn("w-full bg-[#0A0A0A] border-t border-border py-10 md:py-16 lg:py-20", className),
      children: [
        /* @__PURE__ */ jsx54("div", { className: "hidden lg:block mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: /* @__PURE__ */ jsxs32("div", { className: "relative", style: { minHeight: `${contentHeight}px` }, children: [
          /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-2 max-w-[560px]", children: [
            /* @__PURE__ */ jsx54("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-6", children: [
              /* @__PURE__ */ jsxs32("h2", { className: "h2", children: [
                /* @__PURE__ */ jsx54("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ jsxs32(Fragment15, { children: [
                  /* @__PURE__ */ jsx54("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ jsx54("span", { className: "text-[#939393]", children: titleSecondary })
                ] }) : null
              ] }),
              hasParagraphs && /* @__PURE__ */ jsx54(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" })
            ] })
          ] }),
          /* @__PURE__ */ jsx54("div", { className: "absolute bottom-0 left-0 right-0 flex", children: cards.map((card, i) => {
        ...
        /* @__PURE__ */ jsxs32("div", { className: "hidden md:flex lg:hidden flex-col px-8", children: [
          /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-2 mb-6", children: [
            /* @__PURE__ */ jsx54("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-4", children: [
              ...
              hasParagraphs && /* @__PURE__ */ jsx54(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
            ] })
          ] }),
          /* @__PURE__ */ jsx54("div", { className: "grid grid-cols-2 gap-2", children: cards.map((card, i) => /* @__PURE__ */ jsxs32(
            "div",
            {
              className: "bg-[#FFCC00] flex flex-col justify-between p-5 h-[240px]",
              children: [
                /* @__PURE__ */ jsx54("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-20)] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#0A0A0A]", children: card.title }),
                /* @__PURE__ */ jsx54(
                  RichText,
                  {
                    text: card.text,
        ...
        /* @__PURE__ */ jsxs32("div", { className: "flex md:hidden flex-col px-5", children: [
          /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-2 mb-6", children: [
            /* @__PURE__ */ jsx54("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ jsxs32("div", { className: "flex flex-col gap-4", children: [
          ...
          /* @__PURE__ */ jsx54(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx54("div", { className: "px-5 w-fit", children: /* @__PURE__ */ jsx54(
                "div",
                {
                  ...
                  children: cards.map((card, i) => /* @__PURE__ */ jsxs32(
                    "div",
                    {
                      className: "bg-[#FFCC00] flex flex-col justify-between p-5 h-[240px]",
                      children: [
                        /* @__PURE__ */ jsx54("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-20)] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#0A0A0A]", children: card.title }),
                        /* @__PURE__ */ jsx54("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#0A0A0A]", children: card.text })
                      ]
                    },
                    i
                  ))
...
function Arrow({ featured }) {
  return /* @__PURE__ */ jsx55(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx55("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ jsx55("path", { d: "M1 10L10 1M10 1H3M10 1V8", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })
    }
  );
}
function ServiceCard({
  ...
  const content = /* @__PURE__ */ jsxs33(Fragment16, { children: [
    !featured && /* @__PURE__ */ jsx55(GlowingEffect, { spread: 40, glow: false, disabled: false, proximity: 40, inactiveZone: 0.01, borderWidth: 1, variant: "yellow" }),
    card.showArrow !== false && /* @__PURE__ */ jsx55(Arrow, { featured }),
    /* @__PURE__ */ jsx55(
      "h3",
      {
        className: cn(
    ...
    /* @__PURE__ */ jsx55(
      "div",
      {
        ...
        children: (card.paragraphs.length > 0 ? card.paragraphs : [""]).map((p, i) => /* @__PURE__ */ jsx55(
          "p",
          {
            className: cn(
  ...
  if (card.href) {
    return /* @__PURE__ */ jsx55("a", { href: card.href, className: rootCn, children: content });
  }
  return /* @__PURE__ */ jsx55("div", { className: rootCn, children: content });
}
function ServicesSection({
  ...
  const hasParagraphs = resolvedParagraphs.length > 0;
  return /* @__PURE__ */ jsx55("section", { className: cn("w-full border-t border-[#404040] bg-[#0A0A0A] py-10 md:py-16 lg:py-20", className), children: /* @__PURE__ */ jsxs33("div", { className: "mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
    /* @__PURE__ */ jsxs33("div", { className: "mb-8 md:mb-12 flex flex-col gap-4 lg:flex-row lg:gap-10", children: [
      /* @__PURE__ */ jsxs33("div", { className: "flex flex-col gap-4 lg:w-1/2", children: [
        tag && /* @__PURE__ */ jsx55("span", { className: "font-[family-name:var(--font-mono-family)] text-[18px] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[var(--rm-yellow-100)]", children: tag }),
        /* @__PURE__ */ jsxs33("h2", { className: "font-[family-name:var(--font-heading-family)] text-[28px] md:text-[36px] lg:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em]", children: [
          /* @__PURE__ */ jsx55("span", { className: "text-[#F0F0F0]", children: title }),
          titleSecondary ? /* @__PURE__ */ jsxs33(Fragment16, { children: [
            /* @__PURE__ */ jsx55("span", { className: "text-[#F0F0F0]", children: " " }),
            /* @__PURE__ */ jsx55("span", { className: "text-[#939393]", children: titleSecondary })
          ] }) : null
        ] })
      ] }),
      hasParagraphs && /* @__PURE__ */ jsx55("div", { className: "lg:w-1/2 lg:flex lg:items-end", children: /* @__PURE__ */ jsx55(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" }) })
    ] }),
    /* @__PURE__ */ jsx55("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 auto-rows-[minmax(260px,auto)]", children: cards.map((card, i) => /* @__PURE__ */ jsx55(
      ServiceCard,
      {
        card,
...
function CirclePattern({ className }) {
  return /* @__PURE__ */ jsxs34(
    "svg",
    {
      ...
      preserveAspectRatio: "xMidYMid meet",
      children: [
        /* @__PURE__ */ jsx56("circle", { cx: "137.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "277.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "417.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "557.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "137.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "417.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "277.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ jsx56("circle", { cx: "557.5", cy: "244.5", r: "88", stroke: "#404040" })
      ]
    }
  );
}
function ExpertCardHorizontal({ expert }) {
  return /* @__PURE__ */ jsxs34("div", { className: "flex bg-[#121212] p-8 gap-8 h-[349px]", children: [
    /* @__PURE__ */ jsx56(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-2 flex-1", children: [
      /* @__PURE__ */ jsx56("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: expert.tag ?? "\u042D\u043A\u0441\u043F\u0435\u0440\u0442 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0430" }),
      /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-6 flex-1", children: [
        /* @__PURE__ */ jsx56("h3", { className: "h3 text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ jsx56("div", { className: "flex-1 flex items-end", children: /* @__PURE__ */ jsx56(
          RichText,
          {
            text: expert.bio,
...
function ExpertCardVertical({ expert }) {
  return /* @__PURE__ */ jsxs34("div", { className: "flex flex-col bg-[#121212] p-5 gap-8", children: [
    /* @__PURE__ */ jsx56(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx56("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ jsx56(
          RichText,
          {
            text: expert.bio,
...
function ExpertsSection({
  ...
  return /* @__PURE__ */ jsxs34(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx56("div", { className: "hidden lg:block mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: /* @__PURE__ */ jsxs34("div", { className: "grid grid-cols-2 gap-1", children: [
          experts.map((expert, i) => /* @__PURE__ */ jsx56(ExpertCardHorizontal, { expert }, i)),
          isOdd && /* @__PURE__ */ jsx56("div", { className: "flex items-center justify-center h-[349px] p-4", children: /* @__PURE__ */ jsx56(CirclePattern, { className: "w-full h-full" }) })
        ] }) }),
        /* @__PURE__ */ jsx56("div", { className: "hidden md:block lg:hidden px-8", children: /* @__PURE__ */ jsx56("div", { className: "flex flex-col gap-1", children: experts.map((expert, i) => /* @__PURE__ */ jsx56(ExpertCardHorizontal, { expert }, i)) }) }),
        /* @__PURE__ */ jsx56("div", { className: "block md:hidden px-5", children: /* @__PURE__ */ jsx56("div", { className: "flex flex-col gap-1", children: experts.map((expert, i) => /* @__PURE__ */ jsx56(ExpertCardVertical, { expert }, i)) }) })
      ]
    }
  );
}
...
function Avatar3({
  ...
  return /* @__PURE__ */ jsx57(
    "div",
    {
      ...
      children: !expert.image && /* @__PURE__ */ jsx57("div", { className: "flex h-full w-full items-center justify-center", children: /* @__PURE__ */ jsx57("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-18)] font-bold text-[#F0F0F0]", children: expert.name.slice(0, 1) }) })
    }
  );
}
function SingleExpert({ expert, quote }) {
  return /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs35("div", { className: "flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxs35("div", { className: "flex flex-col justify-center gap-1", children: [
        /* @__PURE__ */ jsx57("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: expert.name }),
        expert.tag && /* @__PURE__ */ jsx57("span", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: expert.tag })
      ] })
    ] }),
    quote && /* @__PURE__ */ jsx57("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#939393]", children: quote })
  ] });
}
function MultiExperts({
  ...
  return /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs35("div", { className: "relative w-full", ref: containerRef, children: [
      /* @__PURE__ */ jsx57(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx57(
            "div",
            {
              ...
              children: tipContent && /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx57("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: tipContent.name }),
                tipContent.tag && /* @__PURE__ */ jsx57("span", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: tipContent.tag })
              ] })
            }
          )
        }
      ),
      /* @__PURE__ */ jsx57("div", { className: "flex items-center", children: visible.map((expert, i) => /* @__PURE__ */ jsx57(
        Avatar3,
        {
          expert,
          overlap: i > 0,
...
function HeroExperts({
  ...
  if (experts.length === 0) return null;
  return /* @__PURE__ */ jsx57("div", { className, children: experts.length === 1 ? /* @__PURE__ */ jsx57(SingleExpert, { expert: experts[0], quote }) : /* @__PURE__ */ jsx57(MultiExperts, { experts, quote, maxVisible }) });
}
...
function ToolCardItem({
  ...
  return /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-4 h-full", children: [
    /* @__PURE__ */ jsx58("div", { className: "flex items-end", children: useIcons && tool.icon ? /* @__PURE__ */ jsx58(
      "div",
      {
...
function ToolsSection({
  ...
  return /* @__PURE__ */ jsxs36(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs36("div", { className: "hidden lg:flex flex-col gap-[88px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
          descriptionBelow ? /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsx58("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ jsxs36("h2", { className: "h2", children: [
                /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ jsxs36(Fragment17, { children: [
                  /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ jsx58("span", { className: "text-[#939393]", children: titleSecondary })
                ] }) : null
              ] })
            ] }),
            hasParagraphs && /* @__PURE__ */ jsx58("div", { className: "max-w-[668px]", children: /* @__PURE__ */ jsx58(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" }) })
          ] }) : /* @__PURE__ */ jsxs36("div", { className: "flex", children: [
            /* @__PURE__ */ jsxs36("div", { className: "w-1/2 shrink-0 pr-8 flex flex-col gap-2", children: [
              /* @__PURE__ */ jsx58("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ jsxs36("h2", { className: "h2", children: [
                /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ jsxs36(Fragment17, { children: [
            ...
            hasParagraphs && /* @__PURE__ */ jsx58("div", { className: "w-1/2 flex items-end", children: /* @__PURE__ */ jsx58("div", { className: "max-w-[668px]", children: /* @__PURE__ */ jsx58(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" }) }) })
          ] }),
          (() => {
                ...
                children: tools.map((tool, i) => {
                  ...
                  return /* @__PURE__ */ jsx58(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsx58(ToolCardItem, { tool, useIcons })
                    },
                    i
                  );
                })
        ...
        /* @__PURE__ */ jsxs36("div", { className: "hidden md:flex lg:hidden flex-col gap-10 px-8", children: [
          /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx58("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ jsxs36("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em]", children: [
              /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: title }),
              titleSecondary ? /* @__PURE__ */ jsxs36(Fragment17, { children: [
                /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: " " }),
                /* @__PURE__ */ jsx58("span", { className: "text-[#939393]", children: titleSecondary })
            ...
            hasParagraphs && /* @__PURE__ */ jsx58("div", { className: "mt-2", children: /* @__PURE__ */ jsx58(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" }) })
          ] }),
          /* @__PURE__ */ jsx58("div", { className: "grid grid-cols-2 gap-px bg-[#404040]", children: tools.map((tool, i) => /* @__PURE__ */ jsx58("div", { className: cn("p-8", tool.accent ? "bg-[#FFCC00]" : "bg-[#0A0A0A]"), children: /* @__PURE__ */ jsx58(ToolCardItem, { tool, useIcons }) }, i)) })
        ] }),
        /* @__PURE__ */ jsxs36("div", { className: "flex md:hidden flex-col gap-8 px-5", children: [
          /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx58("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ jsxs36("h2", { className: "h3", children: [
              /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: title }),
              titleSecondary ? /* @__PURE__ */ jsxs36(Fragment17, { children: [
                /* @__PURE__ */ jsx58("span", { className: "text-[#F0F0F0]", children: " " }),
                /* @__PURE__ */ jsx58("span", { className: "text-[#939393]", children: titleSecondary })
            ...
            hasParagraphs && /* @__PURE__ */ jsx58(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
          ] }),
          /* @__PURE__ */ jsx58("div", { className: "flex flex-col", children: tools.map((tool, i) => /* @__PURE__ */ jsx58(
            "div",
            {
              className: cn(
                "p-6",
...
function AccordionFAQ({
  ...
  return /* @__PURE__ */ jsx59("div", { className: cn("w-full max-w-3xl", className), children: /* @__PURE__ */ jsx59(Accordion.Root, { defaultValue: defaultOpen, className: "w-full", children: items.map((item) => /* @__PURE__ */ jsxs37(
    Accordion.Item,
    {
      value: item.id,
      className: "border-b border-border",
      children: [
        /* @__PURE__ */ jsx59(Accordion.Header, { children: /* @__PURE__ */ jsxs37(Accordion.Trigger, { className: "w-full text-left py-5 pl-6 md:pl-14 flex items-start gap-4 cursor-pointer text-foreground/20 transition-colors duration-200 data-[panel-open]:text-primary hover:text-foreground/50", children: [
          /* @__PURE__ */ jsx59("span", { className: "text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] mt-2 shrink-0 tabular-nums", children: item.id }),
          /* @__PURE__ */ jsx59("span", { className: "font-[family-name:var(--font-heading-family)] font-bold uppercase text-3xl md:text-[length:var(--text-52)] leading-none tracking-[-0.02em]", children: item.q })
        ] }) }),
        /* @__PURE__ */ jsx59(Accordion.Panel, { className: "accordion-05-panel", children: /* @__PURE__ */ jsx59("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsx59("p", { className: "pb-6 pl-6 md:px-20 text-[length:var(--text-14)] text-muted-foreground", children: item.a }) }) })
      ]
    },
    item.id
  )) }) });
...
function CTASectionDark({
  ...
  return /* @__PURE__ */ jsx60("section", { className: cn("dark bg-background text-foreground", className), children: /* @__PURE__ */ jsx60("div", { className: "mx-auto w-full max-w-[1512px] px-5 md:px-8 xl:px-14 pb-14 xl:pb-20", children: /* @__PURE__ */ jsxs38("div", { className: "relative overflow-hidden border border-border bg-[#0A0A0A] min-h-[320px] xl:min-h-[424px]", children: [
    /* @__PURE__ */ jsx60(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs38("div", { className: "relative z-10 flex flex-col gap-9 p-8 xl:p-14 xl:max-w-[764px]", children: [
      /* @__PURE__ */ jsxs38("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx60("h2", { className: "font-heading text-[28px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em] text-foreground", children: heading }),
        /* @__PURE__ */ jsx60("p", { className: "text-[15px] xl:text-[18px] leading-[1.2] text-muted-foreground xl:max-w-[672px]", children: body })
      ] }),
      /* @__PURE__ */ jsx60(
        "a",
        {
...
function CTASectionYellow({
  ...
  return /* @__PURE__ */ jsx61(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsx61("div", { className: isArticle ? "" : "mx-auto max-w-[1512px]", children: /* @__PURE__ */ jsxs39(
        "div",
        {
          className: cn(
          ...
          children: [
            /* @__PURE__ */ jsx61(
              "div",
              {
                ...
                "aria-hidden": "true",
                children: /* @__PURE__ */ jsx61(SpiralMobile, { className: "w-full h-full object-cover object-center" })
              }
            ),
            /* @__PURE__ */ jsx61(
              "div",
              {
                ...
                "aria-hidden": "true",
                children: /* @__PURE__ */ jsx61(SpiralDesktop, { className: "h-full w-auto object-contain" })
              }
            ),
            /* @__PURE__ */ jsx61(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs39(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs39("div", { className: "flex flex-col gap-4", children: [
                        /* @__PURE__ */ jsx61(
                          "h3",
                          {
                            className: cn(
                      ...
                      onClick ? /* @__PURE__ */ jsx61("button", { type: "button", onClick, className: buttonClass, children: buttonText }) : /* @__PURE__ */ jsx61("a", { href, className: buttonClass, children: buttonText })
                    ]
                  }
                )
              }
...
function CTASectionMini({
  ...
  return /* @__PURE__ */ jsxs40(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx62("h3", { className: "font-heading text-[18px] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#0A0A0A]", children: heading }),
        body && /* @__PURE__ */ jsx62("p", { className: "text-[13px] leading-[1.32] text-[#0A0A0A]", children: body }),
        onClick ? /* @__PURE__ */ jsx62("button", { type: "button", onClick, className: buttonClass, children: buttonText }) : /* @__PURE__ */ jsx62("a", { href, className: buttonClass, children: buttonText })
      ]
    }
  );
}
...
import { Fragment as Fragment18, jsx as jsx63, jsxs as jsxs41 } from "react/jsx-runtime";
...
function ModalProvider({
  ...
  const value = useMemo4(() => ({ openForm }), [openForm]);
  const activeForm = activeFormId ? formsById.get(activeFormId) : null;
  return /* @__PURE__ */ jsxs41(ModalContext.Provider, { value, children: [
    children,
    /* @__PURE__ */ jsx63(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsx63(DialogContent, { className: "max-w-[560px]", children: activeForm && /* @__PURE__ */ jsx63(
          FormModalBody,
          {
            form: activeForm,
            ctx: openCtx,
...
function FormModalBody({
  ...
  if (submitted) {
    ...
    return /* @__PURE__ */ jsxs41("div", { className: "flex flex-col items-center gap-7 py-8 text-center", children: [
      /* @__PURE__ */ jsx63("div", { className: "flex h-14 w-14 items-center justify-center rounded-full border border-border", children: /* @__PURE__ */ jsx63(Check2, { className: "h-6 w-6 text-foreground", strokeWidth: 2 }) }),
      /* @__PURE__ */ jsx63("p", { className: "h3 text-foreground", children: form.successMessage || "\u0417\u0430\u044F\u0432\u043A\u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0430. \u041C\u044B \u0441\u0432\u044F\u0436\u0435\u043C\u0441\u044F \u0441 \u0432\u0430\u043C\u0438 \u0432 \u0431\u043B\u0438\u0436\u0430\u0439\u0448\u0435\u0435 \u0432\u0440\u0435\u043C\u044F." }),
      hasGift && /* @__PURE__ */ jsxs41(
        "a",
        {
          href: gift.url,
          ...
          children: [
            gift.kind === "file" ? /* @__PURE__ */ jsx63(Download, { className: "h-5 w-5 shrink-0", strokeWidth: 2 }) : /* @__PURE__ */ jsx63(ExternalLink, { className: "h-5 w-5 shrink-0", strokeWidth: 2 }),
...
function DynamicForm({
  ...
  const [touched, setTouched] = useState9({});
  ...
  return /* @__PURE__ */ jsxs41("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs41(DialogHeader, { style: stage(), children: [
      /* @__PURE__ */ jsx63(DialogTitle, { children: form.title || "\u0417\u0430\u044F\u0432\u043A\u0430" }),
      form.description && /* @__PURE__ */ jsx63(DialogDescription, { children: form.description })
    ] }),
    /* @__PURE__ */ jsxs41("div", { className: "flex flex-col gap-3", children: [
      form.fields.name && /* @__PURE__ */ jsx63(FieldShell, { error: errors.name, stage: stage(), children: /* @__PURE__ */ jsx63(
        Input,
        {
      ...
      form.fields.email && /* @__PURE__ */ jsx63(FieldShell, { error: errors.email, stage: stage(), children: /* @__PURE__ */ jsx63(
        Input,
        {
          type: "email",
      ...
      form.fields.phone && /* @__PURE__ */ jsx63(FieldShell, { error: errors.phone, stage: stage(), children: /* @__PURE__ */ jsx63(
        Input,
        {
          type: "tel",
      ...
      form.fields.message && /* @__PURE__ */ jsx63(FieldShell, { error: errors.message, stage: stage(), children: /* @__PURE__ */ jsx63(
        Textarea,
        {
      ...
      showChips && /* @__PURE__ */ jsxs41("div", { className: "flex flex-col gap-1.5", style: stage(), children: [
        chipsLabel && /* @__PURE__ */ jsx63("span", { className: "text-[12px] uppercase tracking-wide text-muted-foreground", children: chipsLabel }),
        /* @__PURE__ */ jsx63("div", { className: "flex flex-wrap gap-1.5", children: availableChips.map((c) => {
    ...
    /* @__PURE__ */ jsx63("div", { style: stage(), children: /* @__PURE__ */ jsx63(
      ConsentCheckbox,
      {
        config: form.consent,
...
function FieldShell({
  ...
  return /* @__PURE__ */ jsxs41("div", { className: "flex flex-col gap-1", style: stage, children: [
    children,
    error && /* @__PURE__ */ jsx63("span", { className: "text-[12px] leading-[1.3] text-destructive", children: error })
  ] });
}
function ConsentCheckbox({
  ...
  return /* @__PURE__ */ jsxs41("label", { className: "flex items-start gap-2 text-[12px] leading-[1.4] text-muted-foreground", children: [
    /* @__PURE__ */ jsx63(
      Checkbox,
      {
        checked,
    ...
    /* @__PURE__ */ jsx63("span", { children: renderConsentText(text, links) })
  ] });
}
function renderConsentText(text, links) {
  if (!text.includes("{links}")) return /* @__PURE__ */ jsx63(Fragment18, { children: text });
  if (links.length === 0) {
    return /* @__PURE__ */ jsx63(Fragment18, { children: text.replace(/\s*\{links\}\s*/g, " ").trim() });
  }
  const [before, after] = text.split("{links}");
  return /* @__PURE__ */ jsxs41(Fragment18, { children: [
    before,
    links.map((l, i) => /* @__PURE__ */ jsxs41("span", { children: [
      i > 0 && ", ",
      /* @__PURE__ */ jsx63(
        "a",
        {
...
function LogoSequence({
  ...
  return /* @__PURE__ */ jsx64(
    "div",
    {
      ...
      children: logos.map((logo) => /* @__PURE__ */ jsx64(
        "div",
        {
...
function InfiniteLogoMarquee({
  ...
  return /* @__PURE__ */ jsx64(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs42("div", { className: `partner-logo-marquee-track${reverse ? " partner-logo-marquee-track--ltr" : ""}`, style: marqueeStyle, children: [
        /* @__PURE__ */ jsx64(LogoSequence, { logos, gap, maxLogoHeight }),
        /* @__PURE__ */ jsx64(LogoSequence, { logos, gap, maxLogoHeight })
      ] })
    }
  );
...
// src/components/ui/mobile-nav.tsx
import { Fragment as Fragment19, jsx as jsx65, jsxs as jsxs43 } from "react/jsx-runtime";
function BurgerIcon({
  open,
  ...
  return /* @__PURE__ */ jsxs43("div", { className: "relative h-[10px] w-[40px]", children: [
    /* @__PURE__ */ jsx65("span", { className: cn(bar, open ? "top-[4px] rotate-45" : "top-0") }),
    /* @__PURE__ */ jsx65("span", { className: cn(bar, open ? "top-[4px] -rotate-45" : "top-[8px]") })
  ] });
}
function MobileNav({
  className,
  ...
  const overlay = mounted ? createPortal(
    /* @__PURE__ */ jsx65(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxs43(
      motion.div,
      {
        ...
        children: [
          origin && /* @__PURE__ */ jsx65(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx65(BurgerIcon, { open: true, barClass: "bg-black" })
            }
          ),
          /* @__PURE__ */ jsxs43(
            "nav",
            {
              ...
              children: [
                /* @__PURE__ */ jsx65("p", { className: "mb-6 font-mono text-[11px] uppercase tracking-[0.1em] text-black/30", children: "Navigation" }),
                navItems.map((item, index) => {
                  ...
                  return /* @__PURE__ */ jsx65(
                    motion.div,
                    {
                      ...
                      children: hasDropdown ? /* @__PURE__ */ jsxs43(Fragment19, { children: [
                        /* @__PURE__ */ jsxs43(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              /* @__PURE__ */ jsx65("span", { children: item.label }),
                              /* @__PURE__ */ jsx65(
                                "svg",
                                {
                                  xmlns: "http://www.w3.org/2000/svg",
                                  ...
                                  children: /* @__PURE__ */ jsx65("path", { d: "M1 1L5 5L9 1" })
                                }
                              )
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsx65(AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ jsx65(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxs43("div", { className: "grid gap-0.5 pb-5", children: [
                              /* @__PURE__ */ jsx65(
                                Link4,
                                {
                                  href: item.href,
                                  ...
                                  children: /* @__PURE__ */ jsx65("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black/50", children: "\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A \u0440\u0430\u0437\u0434\u0435\u043B\u0443" })
                                }
                              ),
                              item.items.map((sub) => /* @__PURE__ */ jsxs43(
                                Link4,
                                {
                                  href: sub.href,
                                  onClick: close,
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsx65("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black", children: sub.title }),
                                    /* @__PURE__ */ jsx65("span", { className: "mt-1 block text-[13px] leading-[1.45] text-black/50", children: sub.description })
                                  ]
                                },
                                sub.href
                              ))
  ...
  return /* @__PURE__ */ jsxs43("div", { className: cn("hero-burger", className), children: [
    /* @__PURE__ */ jsx65(
      "button",
      {
        ref: triggerRef,
        ...
        children: /* @__PURE__ */ jsx65(BurgerIcon, { open: isOpen })
      }
    ),
    overlay
  ] });
...
function RocketmindMenu({
  ...
  return (
    ...
    /* @__PURE__ */ jsxs44("div", { className: cn("relative z-10 flex items-center", className, "gap-0 lg:gap-0"), children: [
      dropdownItems.length > 0 && /* @__PURE__ */ jsx66(
        NavigationMenu,
        {
          className: cn(
          ...
          children: /* @__PURE__ */ jsx66(NavigationMenuList, { className: "flex list-none items-center gap-0.5", children: dropdownItems.map((item) => /* @__PURE__ */ jsx66(
            DropdownSection,
            {
              item,
              itemClassName
      ...
      plainItems.length > 0 && /* @__PURE__ */ jsx66("nav", { className: "flex list-none items-center gap-0.5", children: plainItems.map((item) => /* @__PURE__ */ jsx66(Link5, { href: item.href, className: linkClass, children: /* @__PURE__ */ jsx66("span", { children: item.label }) }, item.label)) })
    ] })
  );
}
function DropdownSection({
  ...
  return /* @__PURE__ */ jsxs44(NavigationMenuItem, { children: [
    /* @__PURE__ */ jsx66(
      NavigationMenuTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx66("span", { children: item.label })
      }
    ),
    /* @__PURE__ */ jsx66(NavigationMenuContent, { children: /* @__PURE__ */ jsx66(
      "ul",
      {
        className: cn(
          "grid gap-0.5 p-2",
        ...
        children: item.items.map((navItem) => /* @__PURE__ */ jsx66("li", { children: /* @__PURE__ */ jsx66(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ jsxs44(
          Link5,
          {
            href: navItem.href,
            ...
            children: [
              /* @__PURE__ */ jsx66("span", { className: "font-mono text-[11px] uppercase tracking-[0.08em] text-foreground", children: navItem.title }),
              /* @__PURE__ */ jsx66("span", { className: "mt-0.5 text-[12px] leading-[1.4] text-muted-foreground", children: navItem.description })
            ]
          }
        ) }) }, navItem.href))
      }
...
function FooterColumn({ title, links }) {
  return /* @__PURE__ */ jsxs45("div", { children: [
    /* @__PURE__ */ jsx68("p", { className: "font-mono text-[11px] uppercase tracking-[0.1em] text-muted-foreground/50", children: title }),
    /* @__PURE__ */ jsx68("ul", { className: "mt-4 flex flex-col gap-2.5", children: links.map((link) => /* @__PURE__ */ jsx68("li", { children: /* @__PURE__ */ jsx68(
      Link6,
      {
        href: link.href,
...
function SiteFooter({
  ...
  return /* @__PURE__ */ jsxs45("footer", { className: className ?? "relative overflow-hidden border-t border-border bg-background", children: [
    /* @__PURE__ */ jsxs45("div", { className: "relative z-10 mx-auto max-w-[1512px] px-5 py-12 md:px-8 md:py-16 xl:px-14", children: [
      /* @__PURE__ */ jsxs45("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx68(Link6, { href: "/", className: "inline-flex items-center", children: /* @__PURE__ */ jsx68(
          "img",
          {
        ...
        /* @__PURE__ */ jsx68(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx68(ChevronUp, { size: 20, strokeWidth: 2 })
          }
        )
      ] }),
      /* @__PURE__ */ jsxs45("div", { className: "mt-10 grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12", children: [
        /* @__PURE__ */ jsxs45("div", { className: "flex flex-col justify-between", children: [
          /* @__PURE__ */ jsx68(FooterColumn, { title: "\u041A\u043E\u043D\u0441\u0430\u043B\u0442\u0438\u043D\u0433", links: consultingLinks.slice(0, 4) }),
          /* @__PURE__ */ jsxs45("p", { className: "mt-8 text-[13px] text-muted-foreground/50 hidden md:block", children: [
            "\xA9 ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " Rocketmind"
          ] })
        ] }),
        /* @__PURE__ */ jsx68(FooterColumn, { title: "\xA0", links: consultingLinks.slice(4) }),
        /* @__PURE__ */ jsxs45("div", { className: "flex flex-col gap-10", children: [
          /* @__PURE__ */ jsx68(FooterColumn, { title: "\u041E\u043D\u043B\u0430\u0439\u043D-\u0448\u043A\u043E\u043B\u0430", links: academyLinks }),
          /* @__PURE__ */ jsx68(FooterColumn, { title: "AI-\u043F\u0440\u043E\u0434\u0443\u043A\u0442\u044B", links: aiProductLinks })
        ] }),
        /* @__PURE__ */ jsx68(FooterColumn, { title: "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F", links: resolvedCompanyLinks })
      ] }),
      /* @__PURE__ */ jsxs45("p", { className: "mt-10 text-[13px] text-muted-foreground/50 md:hidden", children: [
        "\xA9 ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Rocketmind"
      ] })
    ] }),
    /* @__PURE__ */ jsxs45("div", { className: "relative h-[440px] md:h-[460px]", children: [
      /* @__PURE__ */ jsx68(DottedSurface2, {}),
      children && /* @__PURE__ */ jsx68("div", { className: "pointer-events-auto absolute inset-0 z-10 flex flex-col justify-end", children })
    ] })
  ] });
}
...
function SiteHeader({
  ...
  return /* @__PURE__ */ jsx69(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxs46("div", { className: "mx-auto flex w-full max-w-[1512px] items-center justify-between gap-6 px-5 md:px-8 xl:px-14", children: [
        /* @__PURE__ */ jsx69(Link7, { href: "/", className: "flex items-center", children: /* @__PURE__ */ jsx69(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs46("div", { className: "ml-auto flex shrink-0 items-center gap-3", children: [
          /* @__PURE__ */ jsx69(HeaderCtaButton, { cta }),
          /* @__PURE__ */ jsx69(MobileNav, { nav })
        ] })
      ] })
    }
  );
...
function AdminSidebar({
  ...
  return /* @__PURE__ */ jsx70(
    "aside",
    {
      ...
      children: /* @__PURE__ */ jsxs47("div", { className: "relative w-[220px] h-full flex flex-col", children: [
        /* @__PURE__ */ jsxs47("div", { className: "shrink-0 flex items-center border-b border-border", style: { height: 48 }, children: [
          /* @__PURE__ */ jsxs47(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs47("span", { className: "flex-1 min-w-0 flex items-baseline gap-1.5 whitespace-nowrap", children: [
            /* @__PURE__ */ jsx70("span", { className: "text-[length:var(--text-14)] font-semibold text-foreground", children: brand }),
            brandTag && /* @__PURE__ */ jsx70("span", { className: "text-[length:var(--text-14)] font-semibold uppercase text-muted-foreground", children: brandTag })
          ] }),
          /* @__PURE__ */ jsx70(
            "button",
            {
              ...
              children: pinned ? /* @__PURE__ */ jsx70(PanelLeftClose, { size: 16 }) : /* @__PURE__ */ jsx70(PanelLeftOpen, { size: 16 })
            }
          )
        ] }),
        /* @__PURE__ */ jsx70("div", { className: "flex-1 overflow-y-auto overflow-x-hidden py-4", children: /* @__PURE__ */ jsxs47("nav", { ref: navRef, className: "relative", children: [
          /* @__PURE__ */ jsx70(
            "div",
            {
          ...
          sections.map((s) => {
            ...
            return /* @__PURE__ */ jsxs47("div", { children: [
              s.groupHeader && /* @__PURE__ */ jsxs47("div", { className: "mt-3", children: [
                /* @__PURE__ */ jsx70("div", { className: "border-t border-border", "aria-hidden": true }),
                /* @__PURE__ */ jsx70("div", { className: "pt-2 pb-1 pl-3", children: /* @__PURE__ */ jsx70("span", { className: "text-[length:var(--text-10)] font-[family-name:var(--font-mono-family)] uppercase tracking-wider text-muted-foreground/70 whitespace-nowrap", children: s.groupHeader }) })
              ] }),
              /* @__PURE__ */ jsxs47(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs47(
                      LinkComponent,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx70("span", { children: s.label }),
                          s.external && /* @__PURE__ */ jsx70(
                            ExternalLink2,
                            {
                              size: 10,
              ...
              hasSubs && /* @__PURE__ */ jsx70("div", { className: `sidebar-subnav${isOpen ? " is-open" : ""}`, children: /* @__PURE__ */ jsx70(
                "div",
                {
                  ...
                  children: s.subsections.map((sub) => /* @__PURE__ */ jsxs47(
                    "a",
                    {
                      href: `${s.href}#${sub.id}`,
                      className: "flex items-center",
                      ...
                      children: [
                        /* @__PURE__ */ jsx70(
                          "div",
                          {
                            className: "shrink-0 flex items-center justify-center",
                            style: { width: RAIL_W },
                            children: /* @__PURE__ */ jsx70("span", { className: "text-[9px] font-[family-name:var(--font-mono-family)] text-muted-foreground/40 uppercase tracking-wider select-none", children: sub.label.slice(0, 2) })
                          }
                        ),
                        /* @__PURE__ */ jsx70("span", { className: "flex-1 min-w-0 text-[length:var(--text-12)] text-muted-foreground hover:text-foreground transition-colors font-[family-name:var(--font-mono-family)] uppercase tracking-wider whitespace-nowrap opacity-80 pr-2", children: sub.label })
                      ]
                    },
                    sub.id
                  ))
        ...
        /* @__PURE__ */ jsxs47("div", { className: "shrink-0 border-t border-border", children: [
          /* @__PURE__ */ jsxs47(
            Link8,
            {
              href: "/profile",
              ...
              children: [
                /* @__PURE__ */ jsx70(
                  "div",
                  {
                    ...
                    style: { width: RAIL_W },
                    children: /* @__PURE__ */ jsx70(UserCircle, { size: 15 })
                  }
                ),
                /* @__PURE__ */ jsx70("span", { className: "flex-1 min-w-0 text-left text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] uppercase tracking-wider whitespace-nowrap text-muted-foreground truncate pr-2", children: user ? `${user.firstName} ${user.lastName}` : "\u041C\u043E\u0439 \u043F\u0440\u043E\u0444\u0438\u043B\u044C" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs47(
              ...
              children: [
                /* @__PURE__ */ jsx70(
                  "div",
                  {
                    className: "shrink-0 flex items-center justify-center text-muted-foreground",
                    style: { width: RAIL_W },
                    children: isDark ? /* @__PURE__ */ jsx70(Moon, { size: 15 }) : /* @__PURE__ */ jsx70(Sun, { size: 15 })
                  }
                ),
                /* @__PURE__ */ jsx70("span", { className: "flex-1 min-w-0 text-left text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] uppercase tracking-wider whitespace-nowrap text-muted-foreground", children: isDark ? "\u0422\u0451\u043C\u043D\u0430\u044F \u0442\u0435\u043C\u0430" : "\u0421\u0432\u0435\u0442\u043B\u0430\u044F \u0442\u0435\u043C\u0430" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs47(
              ...
              children: [
                /* @__PURE__ */ jsx70(
                  "div",
                  {
                    className: "shrink-0 flex items-center justify-center text-muted-foreground",
                    style: { width: RAIL_W },
                    children: /* @__PURE__ */ jsx70(LogOut, { size: 15 })
                  }
                ),
                /* @__PURE__ */ jsx70("span", { className: "flex-1 min-w-0 text-left text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] uppercase tracking-wider whitespace-nowrap text-muted-foreground", children: "\u0412\u044B\u0439\u0442\u0438" })
              ]
            }
          )
        ] })
...
function AdminShell({ children, ...sidebarProps }) {
  return /* @__PURE__ */ jsx70("div", { className: "fixed inset-0 flex flex-col overflow-hidden bg-background", children: /* @__PURE__ */ jsxs47("div", { className: "flex flex-1 overflow-hidden", children: [
    /* @__PURE__ */ jsx70(AdminSidebar, { ...sidebarProps }),
    /* @__PURE__ */ jsx70("main", { className: "flex flex-1 flex-col overflow-y-auto", children })
  ] }) });
}
export {
  AccordionFAQ,
