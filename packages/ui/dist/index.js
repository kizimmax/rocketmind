...
function FactCard({ title, text }) {
  return /* @__PURE__ */ jsxs12("div", { className: "flex flex-col gap-4", children: [
    ...
    /* @__PURE__ */ jsx29("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#0A0A0A]", children: text })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs12("section", { className: cn("w-full bg-[#F0F0F0]", className), children: [
    /* @__PURE__ */ jsxs12("div", { className: "hidden lg:flex flex-col gap-[104px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14 py-8", children: [
      /* @__PURE__ */ jsxs12("div", { className: "flex flex-col gap-2", children: [
        ...
        /* @__PURE__ */ jsxs12("div", { className: "flex gap-8", children: [
          /* @__PURE__ */ jsx29("h2", { className: "h2 text-[#0A0A0A]", children: title }),
          subtitle && /* @__PURE__ */ jsx29("div", { className: "flex-1 flex items-end", children: /* @__PURE__ */ jsx29("p", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: subtitle }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs12("div", { className: "flex gap-8", children: [
        /* @__PURE__ */ jsx29("div", { className: "flex gap-8 shrink-0", children: col1.map((f, i) => /* @__PURE__ */ jsx29("div", { className: "w-[310px]", children: /* @__PURE__ */ jsx29(FactCard, { ...f }) }, i)) }),
        /* @__PURE__ */ jsx29("div", { className: "flex-1 flex gap-8", children: col2.map((f, i) => /* @__PURE__ */ jsx29("div", { className: "flex-1", children: /* @__PURE__ */ jsx29(FactCard, { ...f }) }, i)) })
      ] })
    ] }),
...
function AccordionFAQ({
  ...
  return /* @__PURE__ */ jsx30("div", { className: cn("w-full max-w-3xl", className), children: /* @__PURE__ */ jsx30(Accordion.Root, { defaultValue: defaultOpen, className: "w-full", children: items.map((item) => /* @__PURE__ */ jsxs13(
    Accordion.Item,
    {
      value: item.id,
      className: "border-b border-border",
      children: [
        /* @__PURE__ */ jsx30(Accordion.Header, { children: /* @__PURE__ */ jsxs13(Accordion.Trigger, { className: "w-full text-left py-5 pl-6 md:pl-14 flex items-start gap-4 cursor-pointer text-foreground/20 transition-colors duration-200 data-[panel-open]:text-primary hover:text-foreground/50", children: [
          /* @__PURE__ */ jsx30("span", { className: "text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] mt-2 shrink-0 tabular-nums", children: item.id }),
          /* @__PURE__ */ jsx30("span", { className: "font-[family-name:var(--font-heading-family)] font-bold uppercase text-3xl md:text-[length:var(--text-52)] leading-none tracking-[-0.02em]", children: item.q })
        ] }) }),
        /* @__PURE__ */ jsx30(Accordion.Panel, { className: "accordion-05-panel", children: /* @__PURE__ */ jsx30("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsx30("p", { className: "pb-6 pl-6 md:px-20 text-[length:var(--text-14)] text-muted-foreground", children: item.a }) }) })
      ]
    },
    item.id
  )) }) });
...
function CTASectionDark({
  ...
  return /* @__PURE__ */ jsx31("section", { className: cn("dark bg-background text-foreground", className), children: /* @__PURE__ */ jsx31("div", { className: "mx-auto w-full max-w-[1512px] px-5 md:px-8 xl:px-14 pb-14 xl:pb-20", children: /* @__PURE__ */ jsxs14("div", { className: "relative overflow-hidden border border-border bg-[#0A0A0A] min-h-[320px] xl:min-h-[424px]", children: [
    /* @__PURE__ */ jsx31(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs14("div", { className: "relative z-10 flex flex-col gap-9 p-8 xl:p-14 xl:max-w-[764px]", children: [
      /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx31("h2", { className: "font-heading text-[28px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em] text-foreground", children: heading }),
        /* @__PURE__ */ jsx31("p", { className: "text-[15px] xl:text-[18px] leading-[1.2] text-muted-foreground xl:max-w-[672px]", children: body })
      ] }),
      /* @__PURE__ */ jsx31(
        "a",
        {
...
function CTASectionYellow({
  ...
  return /* @__PURE__ */ jsx32("section", { className: cn("px-5 md:px-8 xl:px-14 pb-5 md:pb-8 xl:pb-14", className), children: /* @__PURE__ */ jsx32("div", { className: "mx-auto max-w-[1512px]", children: /* @__PURE__ */ jsxs15("div", { className: "bg-[#FFCC00] relative overflow-hidden rounded-none aspect-[353/571] md:aspect-auto md:min-h-[320px] xl:min-h-[400px]", children: [
    /* @__PURE__ */ jsx32(
      "div",
      {
        className: "absolute inset-0 pointer-events-none md:hidden",
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsx32(SpiralMobile, { className: "w-full h-full object-cover object-center" })
      }
    ),
    /* @__PURE__ */ jsx32(
      "div",
      {
        ...
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsx32(SpiralDesktop, { className: "h-full w-auto object-contain" })
      }
    ),
    /* @__PURE__ */ jsx32("div", { className: "relative z-10 p-5 md:px-8 md:py-11 xl:px-14", children: /* @__PURE__ */ jsxs15("div", { className: "flex flex-col gap-9 md:max-w-[75%] lg:max-w-[50%]", children: [
      /* @__PURE__ */ jsxs15("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx32("h2", { className: "font-heading text-[24px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.2] md:leading-[1.08] tracking-[-0.01em] md:tracking-[-0.02em] text-[#0A0A0A]", children: heading }),
        /* @__PURE__ */ jsx32("p", { className: "text-[14px] md:text-[15px] xl:text-[18px] leading-[1.32] text-[#0A0A0A]", children: body })
      ] }),
      /* @__PURE__ */ jsx32(
        "a",
        {
...
function LogoSequence({
  ...
  return /* @__PURE__ */ jsx33(
    "div",
    {
      ...
      children: logos.map((logo) => /* @__PURE__ */ jsx33(
        "div",
        {
...
function InfiniteLogoMarquee({
  ...
  return /* @__PURE__ */ jsx33(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs16("div", { className: `partner-logo-marquee-track${reverse ? " partner-logo-marquee-track--ltr" : ""}`, style: marqueeStyle, children: [
        /* @__PURE__ */ jsx33(LogoSequence, { logos, gap, maxLogoHeight }),
        /* @__PURE__ */ jsx33(LogoSequence, { logos, gap, maxLogoHeight })
      ] })
    }
  );
...
// src/components/ui/mobile-nav.tsx
import { Fragment as Fragment2, jsx as jsx34, jsxs as jsxs17 } from "react/jsx-runtime";
function BurgerIcon({
  open,
  ...
  return /* @__PURE__ */ jsxs17("div", { className: "relative h-[10px] w-[40px]", children: [
    /* @__PURE__ */ jsx34("span", { className: cn(bar, open ? "top-[4px] rotate-45" : "top-0") }),
    /* @__PURE__ */ jsx34("span", { className: cn(bar, open ? "top-[4px] -rotate-45" : "top-[8px]") })
  ] });
}
function MobileNav({ className }) {
  ...
  const overlay = mounted ? createPortal(
    /* @__PURE__ */ jsx34(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxs17(
      motion.div,
      {
        ...
        children: [
          origin && /* @__PURE__ */ jsx34(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx34(BurgerIcon, { open: true, barClass: "bg-black" })
            }
          ),
          /* @__PURE__ */ jsxs17(
            "nav",
            {
              ...
              children: [
                /* @__PURE__ */ jsx34("p", { className: "mb-6 font-mono text-[11px] uppercase tracking-[0.1em] text-black/30", children: "Navigation" }),
                HEADER_NAV.map((item, index) => {
                  ...
                  return /* @__PURE__ */ jsx34(
                    motion.div,
                    {
                      ...
                      children: hasDropdown ? /* @__PURE__ */ jsxs17(Fragment2, { children: [
                        /* @__PURE__ */ jsxs17(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx34(
                                "svg",
                                {
                                  ...
                                  children: /* @__PURE__ */ jsx34("path", { d: "M1 1L5 5L9 1" })
                                }
                              )
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsx34(AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ jsx34(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxs17("div", { className: "grid gap-0.5 pb-5", children: [
                              /* @__PURE__ */ jsx34(
                                Link2,
                                {
                                  href: item.href,
                                  ...
                                  children: /* @__PURE__ */ jsx34("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black/50", children: "\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A \u0440\u0430\u0437\u0434\u0435\u043B\u0443" })
                                }
                              ),
                              item.items.map((sub) => /* @__PURE__ */ jsxs17(
                                Link2,
                                {
                                  href: sub.href,
                                  onClick: close,
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsx34("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black", children: sub.title }),
                                    /* @__PURE__ */ jsx34("span", { className: "mt-1 block text-[13px] leading-[1.45] text-black/50", children: sub.description })
                                  ]
                                },
                                sub.href
                              ))
  ...
  return /* @__PURE__ */ jsxs17("div", { className: cn("hero-burger", className), children: [
    /* @__PURE__ */ jsx34(
      "button",
      {
        ref: triggerRef,
        ...
        children: /* @__PURE__ */ jsx34(BurgerIcon, { open: isOpen })
      }
    ),
    overlay
  ] });
...
function RocketmindMenu({
  ...
  return /* @__PURE__ */ jsxs18("div", { className: cn("relative z-10 flex items-center", className), children: [
    dropdownItems.length > 0 && /* @__PURE__ */ jsx35(
      NavigationMenu,
      {
        className: cn(
        ...
        children: /* @__PURE__ */ jsx35(NavigationMenuList, { className: "flex list-none items-center gap-0.5", children: dropdownItems.map((item) => /* @__PURE__ */ jsx35(
          DropdownSection,
          {
            item,
            itemClassName
    ...
    plainItems.length > 0 && /* @__PURE__ */ jsx35("nav", { className: "flex list-none items-center gap-0.5", children: plainItems.map((item) => /* @__PURE__ */ jsx35(Link3, { href: item.href, className: linkClass, children: /* @__PURE__ */ jsx35("span", { children: item.label }) }, item.label)) })
  ] });
}
function DropdownSection({
  ...
  return /* @__PURE__ */ jsxs18(NavigationMenuItem, { children: [
    /* @__PURE__ */ jsx35(
      NavigationMenuTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx35("span", { children: item.label })
      }
    ),
    /* @__PURE__ */ jsx35(NavigationMenuContent, { children: /* @__PURE__ */ jsx35(
      "ul",
      {
        className: cn(
          "grid gap-0.5 p-2",
        ...
        children: item.items.map((navItem) => /* @__PURE__ */ jsx35("li", { children: /* @__PURE__ */ jsx35(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ jsxs18(
          Link3,
          {
            href: navItem.href,
            ...
            children: [
              /* @__PURE__ */ jsx35("span", { className: "font-mono text-[11px] uppercase tracking-[0.08em] text-foreground", children: navItem.title }),
              /* @__PURE__ */ jsx35("span", { className: "mt-0.5 text-[12px] leading-[1.4] text-muted-foreground", children: navItem.description })
            ]
          }
        ) }) }, navItem.href))
      }
...
function FooterColumn({ title, links }) {
  return /* @__PURE__ */ jsxs19("div", { children: [
    /* @__PURE__ */ jsx36("p", { className: "font-mono text-[11px] uppercase tracking-[0.1em] text-muted-foreground/50", children: title }),
    /* @__PURE__ */ jsx36("ul", { className: "mt-4 flex flex-col gap-2.5", children: links.map((link) => /* @__PURE__ */ jsx36("li", { children: /* @__PURE__ */ jsx36(
      Link4,
      {
        href: link.href,
        scroll: false,
...
function SiteFooter({ basePath = "", className }) {
  ...
  return /* @__PURE__ */ jsx36("footer", { className: className ?? "border-t border-border bg-background", children: /* @__PURE__ */ jsxs19("div", { className: "mx-auto max-w-[1512px] px-5 py-12 md:px-8 md:py-16 xl:px-14", children: [
    /* @__PURE__ */ jsxs19("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx36(Link4, { href: "/", className: "inline-flex items-center", children: /* @__PURE__ */ jsx36(
        "img",
        {
      ...
      /* @__PURE__ */ jsx36(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx36(ChevronUp, { size: 20, strokeWidth: 2 })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs19("div", { className: "mt-10 grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12", children: [
      /* @__PURE__ */ jsxs19("div", { className: "flex flex-col justify-between", children: [
        /* @__PURE__ */ jsx36(FooterColumn, { title: "\u041A\u043E\u043D\u0441\u0430\u043B\u0442\u0438\u043D\u0433", links: consultingLinks.slice(0, 4) }),
        /* @__PURE__ */ jsxs19("p", { className: "mt-8 text-[13px] text-muted-foreground/50 hidden md:block", children: [
          "\xA9 ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Rocketmind"
        ] })
      ] }),
      /* @__PURE__ */ jsx36(FooterColumn, { title: "\xA0", links: consultingLinks.slice(4) }),
      /* @__PURE__ */ jsxs19("div", { className: "flex flex-col gap-10", children: [
        /* @__PURE__ */ jsx36(FooterColumn, { title: "\u041E\u043D\u043B\u0430\u0439\u043D-\u0448\u043A\u043E\u043B\u0430", links: academyLinks }),
        /* @__PURE__ */ jsx36(FooterColumn, { title: "AI-\u043F\u0440\u043E\u0434\u0443\u043A\u0442\u044B", links: aiProductLinks })
      ] }),
      /* @__PURE__ */ jsx36(FooterColumn, { title: "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F", links: COMPANY_LINKS })
    ] }),
    /* @__PURE__ */ jsxs19("p", { className: "mt-10 text-[13px] text-muted-foreground/50 md:hidden", children: [
      "\xA9 ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Rocketmind"
    ] })
...
function SiteHeader({ basePath = "", className }) {
  ...
  return /* @__PURE__ */ jsx37(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxs20("div", { className: "mx-auto flex w-full max-w-[1512px] items-center justify-between gap-6 px-5 md:px-8 xl:px-14", children: [
        /* @__PURE__ */ jsx37(Link5, { href: "/", className: "flex items-center", children: /* @__PURE__ */ jsx37(
          "img",
          {
        ...
        /* @__PURE__ */ jsx37(MobileNav, { className: "ml-auto" })
      ] })
    }
  );
}
