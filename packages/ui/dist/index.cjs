...
function ProductCard({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "absolute top-1 right-1 z-10 flex items-center justify-center w-10 h-10 rounded-[4px] text-[#F0F0F0] opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      "path",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: cn("flex flex-col", icon ? "gap-6 md:gap-8" : ""), children: [
      icon && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "w-[120px] h-[120px] shrink-0", children: icon }),
          hasExperts && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex items-center -ml-[18px] pb-10 pt-2 justify-end", children: [
            ...
            extra > 0 && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "w-[72px] h-[72px] rounded-full bg-[#1A1A1A] flex items-center justify-center shrink-0 -ml-4", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("span", { className: "font-heading text-[24px] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0]", children: [
              "+",
              extra
            ] }) })
          ] })
        ] }),
        tag && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "-mt-[22px]", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "inline-flex items-center px-2.5 py-1 bg-[#3D3300] border border-[#4A3C00] font-['Loos_Condensed',sans-serif] text-[12px] font-medium uppercase tracking-[0.02em] leading-[1.2] text-[#FFE466]", children: tag }) })
      ] }),
...
function FactCard({ title, text }) {
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "grid grid-rows-[subgrid] row-span-3 gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h4", { className: "h4 text-[#0A0A0A]", children: title }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "h-0 w-full border-t border-[#404040]" }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#0A0A0A] max-w-[480px]", children: text }) })
  ] });
}
function ForWhomSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("section", { className: cn("w-full bg-[#F0F0F0] py-10 md:py-16 lg:py-20", className), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "flex lg:hidden flex-col gap-16 px-5 md:px-8", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "flex flex-col gap-7", children: facts.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "grid", style: { gridTemplateRows: "auto auto 1fr" }, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(FactCard, { ...f }) }, i)) })
    ] })
  ] });
}
...
function StepCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: cn("flex gap-10 max-w-[364px]", className), children: [
...
function ParticipantsBlock({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: cn("bg-[#121212] rounded p-8 flex flex-col gap-8 max-w-[648px]", className), children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "hidden md:flex lg:hidden gap-10 px-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "w-[45%] shrink-0 flex flex-col", children: [
            /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "flex-1 pb-10", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "sticky top-24", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
                /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: title })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex flex-col gap-1", children: [
            ...
            hasParticipants && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
              ParticipantsBlock,
              {
                tag: participantsTag,
                participants,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex md:hidden flex-col px-5", children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "hidden md:flex lg:hidden flex-col px-8", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "grid grid-cols-2 gap-2", children: cards.map((card, i) => /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
            "div",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "flex md:hidden flex-col px-5", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "px-5 w-fit", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
                "div",
                {
...
function CirclePattern({ className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "137.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "277.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "417.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "557.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "137.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "417.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "277.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("circle", { cx: "557.5", cy: "244.5", r: "88", stroke: "#404040" })
      ]
    }
  );
}
function ExpertCardHorizontal({ expert }) {
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex bg-[#121212] p-8 gap-8 h-[349px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex flex-col gap-2 flex-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: expert.tag ?? "\u042D\u043A\u0441\u043F\u0435\u0440\u0442 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0430" }),
      /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex flex-col gap-6 flex-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("h3", { className: "h3 text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: "flex-1 flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("p", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: expert.bio }) })
      ] })
    ] })
  ] });
}
function ExpertCardVertical({ expert }) {
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex flex-col bg-[#121212] p-5 gap-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
      "div",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393]", children: expert.bio })
      ] })
    ] })
  ] });
}
...
function ToolCardItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "flex flex-col gap-4 h-full", children: [
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "flex items-end", children: useIcons && tool.icon ? /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
      "div",
      {
        className: "h-[86px] w-[86px] bg-contain bg-center bg-no-repeat",
        style: { backgroundImage: `url(${tool.icon})` }
      }
    ) : /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[80px] font-medium leading-[1.08] tracking-[0.02em] text-transparent [-webkit-text-stroke:1px_#404040]", children: tool.number }) }),
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("h4", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#F0F0F0]", children: tool.title }),
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393]", children: tool.text })
  ] });
}
function ToolsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "hidden lg:flex flex-col gap-[88px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
          /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "flex", children: [
            /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "w-1/2 shrink-0 pr-8 flex flex-col gap-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("h2", { className: "h2 text-[#F0F0F0]", children: title })
            ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "hidden md:flex lg:hidden flex-col gap-10 px-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: title }),
            description && /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393] mt-2", children: description })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "grid grid-cols-2 gap-px bg-[#404040]", children: tools.map((tool, i) => /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "bg-[#0A0A0A] p-8", children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ToolCardItem, { tool, useIcons }) }, i)) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "flex md:hidden flex-col gap-8 px-5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("h2", { className: "h3 text-[#F0F0F0]", children: title }),
            description && /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393]", children: description })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "flex flex-col", children: tools.map((tool, i) => /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "border border-[#404040] p-6", children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ToolCardItem, { tool, useIcons }) }, i)) })
        ] })
      ]
    }
  );
...
function AccordionFAQ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { className: cn("w-full max-w-3xl", className), children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_react7.Accordion.Root, { defaultValue: defaultOpen, className: "w-full", children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(
    import_react7.Accordion.Item,
    {
      value: item.id,
      className: "border-b border-border",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_react7.Accordion.Header, { children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(import_react7.Accordion.Trigger, { className: "w-full text-left py-5 pl-6 md:pl-14 flex items-start gap-4 cursor-pointer text-foreground/20 transition-colors duration-200 data-[panel-open]:text-primary hover:text-foreground/50", children: [
          /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("span", { className: "text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] mt-2 shrink-0 tabular-nums", children: item.id }),
          /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("span", { className: "font-[family-name:var(--font-heading-family)] font-bold uppercase text-3xl md:text-[length:var(--text-52)] leading-none tracking-[-0.02em]", children: item.q })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_react7.Accordion.Panel, { className: "accordion-05-panel", children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { className: "overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("p", { className: "pb-6 pl-6 md:px-20 text-[length:var(--text-14)] text-muted-foreground", children: item.a }) }) })
      ]
    },
    item.id
  )) }) });
...
function CTASectionDark({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("section", { className: cn("dark bg-background text-foreground", className), children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "mx-auto w-full max-w-[1512px] px-5 md:px-8 xl:px-14 pb-14 xl:pb-20", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: "relative overflow-hidden border border-border bg-[#0A0A0A] min-h-[320px] xl:min-h-[424px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: "relative z-10 flex flex-col gap-9 p-8 xl:p-14 xl:max-w-[764px]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("h2", { className: "font-heading text-[28px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em] text-foreground", children: heading }),
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("p", { className: "text-[15px] xl:text-[18px] leading-[1.2] text-muted-foreground xl:max-w-[672px]", children: body })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
        "a",
        {
...
function CTASectionYellow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("section", { className: cn("px-5 md:px-8 xl:px-14 pb-5 md:pb-8 xl:pb-14", className), children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { className: "mx-auto max-w-[1512px]", children: /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "bg-[#FFCC00] relative overflow-hidden rounded-none aspect-[353/571] md:aspect-auto md:min-h-[320px] xl:min-h-[400px]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
      "div",
      {
        className: "absolute inset-0 pointer-events-none md:hidden",
        "aria-hidden": "true",
        children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(SpiralMobile, { className: "w-full h-full object-cover object-center" })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
      "div",
      {
        ...
        "aria-hidden": "true",
        children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(SpiralDesktop, { className: "h-full w-auto object-contain" })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { className: "relative z-10 p-5 md:px-8 md:py-11 xl:px-14", children: /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "flex flex-col gap-9 md:max-w-[75%] lg:max-w-[50%]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("h2", { className: "font-heading text-[24px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.2] md:leading-[1.08] tracking-[-0.01em] md:tracking-[-0.02em] text-[#0A0A0A]", children: heading }),
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("p", { className: "text-[14px] md:text-[15px] xl:text-[18px] leading-[1.32] text-[#0A0A0A]", children: body })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
        "a",
        {
...
function LogoSequence({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    "div",
    {
      ...
      children: logos.map((logo) => /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
        "div",
        {
...
function InfiniteLogoMarquee({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)("div", { className: `partner-logo-marquee-track${reverse ? " partner-logo-marquee-track--ltr" : ""}`, style: marqueeStyle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(LogoSequence, { logos, gap, maxLogoHeight }),
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(LogoSequence, { logos, gap, maxLogoHeight })
      ] })
    }
  );
...
function BurgerIcon({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "relative h-[10px] w-[40px]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: cn(bar, open ? "top-[4px] rotate-45" : "top-0") }),
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: cn(bar, open ? "top-[4px] -rotate-45" : "top-[8px]") })
  ] });
}
function MobileNav({ className }) {
  ...
  const overlay = mounted ? (0, import_react_dom.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_react9.AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
      import_react9.motion.div,
      {
        ...
        children: [
          origin && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
            "button",
            {
              type: "button",
              onClick: close,
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(BurgerIcon, { open: true, barClass: "bg-black" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
            "nav",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("p", { className: "mb-6 font-mono text-[11px] uppercase tracking-[0.1em] text-black/30", children: "Navigation" }),
                HEADER_NAV.map((item, index) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
                    import_react9.motion.div,
                    {
                      ...
                      children: hasDropdown ? /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
                                "svg",
                                {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("path", { d: "M1 1L5 5L9 1" })
                                }
                              )
                            ]
                          }
                        ),
                        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_react9.AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
                          import_react9.motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "grid gap-0.5 pb-5", children: [
                              /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
                                import_link.default,
                                {
                                  href: item.href,
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black/50", children: "\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A \u0440\u0430\u0437\u0434\u0435\u043B\u0443" })
                                }
                              ),
                              item.items.map((sub) => /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
                                import_link.default,
                                {
                                  href: sub.href,
                                  onClick: close,
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black", children: sub.title }),
                                    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: "mt-1 block text-[13px] leading-[1.45] text-black/50", children: sub.description })
                                  ]
                                },
                                sub.href
                              ))
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: cn("hero-burger", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
      "button",
      {
        ref: triggerRef,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(BurgerIcon, { open: isOpen })
      }
    ),
    overlay
  ] });
...
function RocketmindMenu({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: cn("relative z-10 flex items-center", className), children: [
    dropdownItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      NavigationMenu,
      {
        className: cn(
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(NavigationMenuList, { className: "flex list-none items-center gap-0.5", children: dropdownItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
          DropdownSection,
          {
            item,
            itemClassName
    ...
    plainItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("nav", { className: "flex list-none items-center gap-0.5", children: plainItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(import_link2.default, { href: item.href, className: linkClass, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { children: item.label }) }, item.label)) })
  ] });
}
function DropdownSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(NavigationMenuItem, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      NavigationMenuTrigger,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { children: item.label })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(NavigationMenuContent, { children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      "ul",
      {
        className: cn(
          "grid gap-0.5 p-2",
        ...
        children: item.items.map((navItem) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
          import_link2.default,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "font-mono text-[11px] uppercase tracking-[0.08em] text-foreground", children: navItem.title }),
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "mt-0.5 text-[12px] leading-[1.4] text-muted-foreground", children: navItem.description })
            ]
          }
        ) }) }, navItem.href))
      }
...
function SiteFooter({ basePath = "", className, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)("footer", { className: className ?? "relative overflow-hidden border-t border-border bg-background", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)("div", { className: "relative h-[440px] md:h-[460px]", children: [
