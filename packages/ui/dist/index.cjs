...
function ArticleBody({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: cn("flex flex-col items-stretch", className), ...props, children: blocks.map((block, i) => {
    ...
    switch (block.type) {
      ...
      case "quote":
        return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(Quote, { text, className: mt }, block.id);
      default:
        return null;
    }
  }) });
...
function FormModalBody({
  ...
  if (submitted) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)("div", { className: "flex flex-col items-center gap-7 py-8 text-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime61.jsx)("p", { className: "h2 text-foreground", children: form.successMessage || "\u0417\u0430\u044F\u0432\u043A\u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0430. \u041C\u044B \u0441\u0432\u044F\u0436\u0435\u043C\u0441\u044F \u0441 \u0432\u0430\u043C\u0438 \u0432 \u0431\u043B\u0438\u0436\u0430\u0439\u0448\u0435\u0435 \u0432\u0440\u0435\u043C\u044F." }),
