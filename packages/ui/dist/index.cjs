...
var import_react12, import_jsx_runtime56;
...
function Author({
  ...
  if (variant === "short") {
    return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(Avatar, { size: "xs", className: "shrink-0 border-0", children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(
    "div",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(Avatar, { size: "md", className: "shrink-0 border-0", children: [
          avatarUrl ? /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(AvatarImage, { src: avatarUrl, alt: name }) : null,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
    "article",
    {
      ...
      children: [
        href && /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
            "span",
            {
              ...
              "aria-hidden": true,
              children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_lucide_react7.ArrowUpRight, { className: "h-5 w-5", strokeWidth: 1.5 })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "relative -mx-[0] mb-[-53px] h-56 overflow-hidden", children: [
          coverUrl ? (
        ...
        visibleTags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("div", { className: "relative z-[1] mt-[-24px] flex flex-wrap gap-x-2 gap-y-1", children: visibleTags.map((t) => /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(Tag, { size: "s", children: t }, t)) }),
        /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "relative z-[1] mt-7 flex flex-col gap-5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("h3", { className: "font-[family-name:var(--font-heading-family)] font-bold text-[length:var(--text-24)] uppercase tracking-[-0.01em] leading-[1.2] text-[color:var(--rm-gray-fg-main)]", children: title }),
            description && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("p", { className: "line-clamp-3 text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[color:var(--rm-gray-fg-sub)]", children: description })
          ] }),
...
function FactCard({ title, text }) {
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "grid grid-rows-[subgrid] row-span-3 gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("h4", { className: "h4 text-[#0A0A0A]", children: title }) }),
    /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "h-0 w-full border-t border-[#404040]" }),
...
function ForWhomSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("section", { className: cn("w-full bg-[#F0F0F0] py-10 md:py-16 lg:py-20", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "hidden lg:flex flex-col gap-[104px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
      /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex", children: [
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "w-1/2 shrink-0 pr-8", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("h2", { className: "h2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#0A0A0A]", children: title }),
            titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#0A0A0A]", children: " " }),
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#666666]", children: titleSecondary })
            ] }) : null
          ] }) }),
          hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "w-1/2", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "max-w-[480px]", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphsDesktop, theme: "light", size: "18" }) }) })
        ] })
      ] }),
      (() => {
        let leftFacts;
        ...
        const renderCard = (f, i) => /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("h4", { className: "h4 text-[#0A0A0A]", children: f.title }) }),
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "h-0 w-full border-t border-[#404040]" }),
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex", children: [
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "w-1/2 flex gap-4 pr-4", children: leftFacts.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "flex-1", children: renderCard(f, i) }, i)) }),
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "w-1/2 flex gap-4", children: rightFacts.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "flex-1", children: renderCard(f, i) }, i)) })
        ] });
      })()
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex lg:hidden flex-col gap-16 px-5 md:px-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("h2", { className: "h3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#0A0A0A]", children: title }),
          titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#0A0A0A]", children: " " }),
            /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "text-[#666666]", children: titleSecondary })
        ...
        hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphsDesktop, theme: "light", size: "16" }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "flex flex-col gap-7", children: facts.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "grid", style: { gridTemplateRows: "auto auto 1fr" }, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(FactCard, { ...f }) }, i)) })
    ] })
  ] });
}
...
function VkIcon({ className, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("rect", { x: "0.75", y: "0.75", width: "38.5", height: "38.5", rx: "4", stroke: "currentColor", strokeWidth: "1.5" }),
...
function TelegramIcon({ className, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime41.jsx)("rect", { x: "0.75", y: "0.75", width: "38.5", height: "38.5", rx: "4", stroke: "currentColor", strokeWidth: "1.5" }),
...
function SocialIcon({
  ...
  if (kind === "vk") return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(VkIcon, { className });
  if (kind === "telegram") return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TelegramIcon, { className });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
    "span",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("img", { src: iconSrc, alt: "", className: "h-5 w-5 object-contain" })
    }
  );
}
...
function SocialsItem({ socials }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TooltipProvider, { delay: 150, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex flex-wrap items-center gap-2 text-[#0A0A0A]", children: socials.map((s) => {
    const label = socialTooltipText(s);
    const icon = /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
      SocialIcon,
      {
        kind: s.kind,
        iconSrc: s.iconSrc,
    ...
    const trigger = s.url ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
      "a",
      {
        href: s.url,
        target: "_blank",
    ...
    ) : /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { "aria-label": label || s.username, className: "group/social inline-flex", children: icon });
    if (!label) return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(React13.Fragment, { children: trigger }, s.id);
    return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(Tooltip, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TooltipTrigger, { render: trigger }),
      /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TooltipContent, { children: label })
    ] }, s.id);
  }) }) });
}
function PersonItem({ person }) {
  const socialLabel = person.social ? socialTooltipText(person.social) : "";
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex items-start gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex min-w-0 flex-1 flex-col gap-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "text-[length:var(--text-16)] font-medium leading-[1.28] text-[#0A0A0A]", children: person.name }),
      person.role ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "text-[length:var(--text-14)] leading-[1.32] text-[#404040]", children: person.role }) : null,
      person.phone ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
        "a",
        {
      ...
      person.social && (person.social.url || person.social.username) ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TooltipProvider, { delay: 150, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "mt-1 inline-flex text-[#0A0A0A]", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(Tooltip, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
          TooltipTrigger,
          {
            render: person.social.url ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
              "a",
              {
            ...
            ) : /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "inline-flex", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
              SocialIcon,
              {
                kind: person.social.kind,
                iconSrc: person.social.iconSrc
        ...
        socialLabel ? /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(TooltipContent, { children: socialLabel }) : null
      ] }) }) }) : null
    ] })
  ] });
}
function CardItemRenderer({ item }) {
  if (item.kind === "paragraph") return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(ParagraphItem, { paragraph: item.paragraph });
  if (item.kind === "socials") return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(SocialsItem, { socials: item.socials });
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(PersonItem, { person: item.person });
}
function ContactCardView({ card }) {
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("h4", { className: "h4 text-[#0A0A0A]", children: card.title }) }),
    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "h-0 w-full border-t border-[#404040]" }),
    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex flex-col gap-4", children: card.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(CardItemRenderer, { item }, item.id)) })
  ] });
}
function ContactsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("section", { className: cn("w-full bg-[#F0F0F0] py-10 md:py-16 lg:py-20", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "hidden lg:flex flex-col gap-[104px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
      /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex", children: [
          /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "w-1/2 shrink-0 pr-8", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("h2", { className: "h2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#0A0A0A]", children: title }),
            titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#0A0A0A]", children: " " }),
              /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#666666]", children: titleSecondary })
            ] }) : null
          ] }) }),
          hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "w-1/2", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "max-w-[480px]", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "light", size: "18" }) }) })
        ] })
      ] }),
      cards.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex", children: [
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "w-1/2 flex gap-4 pr-4", children: leftCards.map((card) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex-1", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(ContactCardView, { card }) }, card.id)) }),
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "w-1/2 flex gap-4", children: rightCards.map((card) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex-1", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(ContactCardView, { card }) }, card.id)) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex lg:hidden flex-col gap-16 px-5 md:px-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#0A0A0A]", children: tag }),
        /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("h2", { className: "h3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#0A0A0A]", children: title }),
          titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#0A0A0A]", children: " " }),
            /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("span", { className: "text-[#666666]", children: titleSecondary })
        ...
        hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "light", size: "16" }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "flex flex-col gap-7", children: cards.map((card) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(ContactCardView, { card }, card.id)) })
    ] })
  ] });
}
...
function TimelineColumn({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "relative w-px shrink-0 self-stretch", children: [
    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "absolute inset-0 bg-[#404040]" }),
...
function StepCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: cn("flex gap-10 max-w-[364px]", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(TimelineColumn, { isActive, isLast, fillProgress }),
    /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-3 pb-16", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { style: { color: isActive ? "#939393" : "rgba(147,147,147,0.5)" }, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
        RichText,
        {
          text: step.text,
...
function ParticipantsBlock({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: cn("bg-[#121212] rounded p-8 flex flex-col gap-8 max-w-[648px]", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex flex-col gap-5", children: participants.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-16)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#F0F0F0]", children: p.role }),
      /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
        RichText,
        {
          text: p.text,
...
function AcademyStepCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex items-start gap-6 lg:w-1/2 lg:items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "flex-1 h4 text-[#F0F0F0]", children: step.title }),
          /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "w-[100px] shrink-0 text-right lg:text-left lg:order-first font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: step.number })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "pl-0 lg:w-1/2 lg:pl-4", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
          RichText,
          {
            text: step.text,
            className: "text-[length:var(--text-16)] leading-[1.28] text-[#939393]"
...
function ProcessSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "hidden lg:flex mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
          /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "w-1/2 shrink-0 pr-8 flex flex-col", children: [
            /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex-1 pb-10", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "sticky top-24", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-8 max-w-[560px]", children: [
              /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
                /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("h2", { className: "h2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                  titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
                  ] }) : null
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(RichText, { text: subtitle, className: subtitleClassDesktop }),
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" })
              ] })
            ] }) }) }),
            hasParticipants && /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "max-w-[648px]", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(ParticipantsBlock, { tag: participantsTag, participants }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "w-1/2 pt-10", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(AcademyStepCard, { step, isFirst: i === 0 }, i)) : steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { "data-step": true, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
            StepCard,
            {
              step,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "hidden md:flex lg:hidden gap-10 px-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "w-[45%] shrink-0 flex flex-col", children: [
            /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex-1 pb-10", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "sticky top-24", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
                /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em]", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                  titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                    /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
              ...
              /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(RichText, { text: subtitle, className: subtitleClassSmall }),
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
              ] })
            ] }) }) }),
            hasParticipants && /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
              ParticipantsBlock,
              {
                tag: participantsTag,
                participants,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex-1 pt-10", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(AcademyStepCard, { step, isFirst: i === 0, className: "lg:flex-col lg:items-start" }, i)) : steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { "data-step": true, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
            StepCard,
            {
              step,
              isActive: i <= activeIndex,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex md:hidden flex-col px-5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-4 mb-10", children: [
            /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("h2", { className: "h3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "flex flex-col", children: isAcademy ? steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(AcademyStepCard, { step, isFirst: i === 0 }, i)) : steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { "data-step": true, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
            StepCard,
            {
              step,
              isActive: i <= activeIndex,
          ...
          hasParticipants && /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: "mt-4", children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(ParticipantsBlock, { tag: participantsTag, participants }) })
        ] })
      ]
    }
  );
...
function ResultsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(
    "section",
    {
      ...
      className: cn("w-full bg-[#0A0A0A] border-t border-border py-10 md:py-16 lg:py-20", className),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: "hidden lg:block mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "relative", style: { minHeight: `${contentHeight}px` }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-2 max-w-[560px]", children: [
            /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("h2", { className: "h2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
                ] }) : null
              ] }),
              hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: "absolute bottom-0 left-0 right-0 flex", children: cards.map((card, i) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "hidden md:flex lg:hidden flex-col px-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-2 mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em]", children: [
                /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
              ...
              hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: "grid grid-cols-2 gap-2", children: cards.map((card, i) => /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(
            "div",
            {
              className: "bg-[#FFCC00] flex flex-col justify-between p-5 h-[240px]",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-20)] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#0A0A0A]", children: card.title }),
                /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
                  RichText,
                  {
                    text: card.text,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex md:hidden flex-col px-5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-2 mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", { className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("h2", { className: "h3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: "px-5 w-fit", children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
                "div",
                {
                  ...
                  children: cards.map((card, i) => /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(
                    "div",
                    {
                      className: "bg-[#FFCC00] flex flex-col justify-between p-5 h-[240px]",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-20)] font-bold uppercase leading-[1.2] tracking-[-0.01em] text-[#0A0A0A]", children: card.title }),
                        /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("p", { className: "text-[length:var(--text-16)] leading-[1.28] text-[#0A0A0A]", children: card.text })
                      ]
                    },
                    i
                  ))
...
function Arrow({ featured }) {
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("path", { d: "M1 10L10 1M10 1H3M10 1V8", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })
    }
  );
}
function ServiceCard({ card }) {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
    !featured && /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(GlowingEffect, { spread: 40, glow: false, disabled: false, proximity: 40, inactiveZone: 0.01, borderWidth: 1, variant: "yellow" }),
    card.showArrow !== false && /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Arrow, { featured }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
      "div",
      {
        ...
        children: (card.paragraphs.length > 0 ? card.paragraphs : [""]).map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
          "p",
          {
            className: cn(
  ...
  if (card.href) {
    return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("a", { href: card.href, className: rootCn, children: content });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("div", { className: rootCn, children: content });
}
function ServicesSection({
  ...
  const hasParagraphs = resolvedParagraphs.length > 0;
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("section", { className: cn("w-full border-t border-[#404040] bg-[#0A0A0A] py-10 md:py-16 lg:py-20", className), children: /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)("div", { className: "mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
    /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)("div", { className: "mb-8 md:mb-12 flex flex-col gap-4 lg:flex-row lg:gap-10", children: [
      /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)("div", { className: "flex flex-col gap-4 lg:w-1/2", children: [
        tag && /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[18px] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[var(--rm-yellow-100)]", children: tag }),
        /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[28px] md:text-[36px] lg:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
          titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
            /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
          ] }) : null
        ] })
      ] }),
      hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("div", { className: "lg:w-1/2 lg:flex lg:items-end", children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "16" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 auto-rows-[minmax(260px,auto)]", children: cards.map((card, i) => /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(ServiceCard, { card }, i)) })
  ] }) });
}
...
function CirclePattern({ className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "137.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "277.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "417.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "557.5", cy: "104.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "137.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "417.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "277.5", cy: "244.5", r: "88", stroke: "#404040" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("circle", { cx: "557.5", cy: "244.5", r: "88", stroke: "#404040" })
      ]
    }
  );
}
function ExpertCardHorizontal({ expert }) {
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex bg-[#121212] p-8 gap-8 h-[349px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex flex-col gap-2 flex-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: expert.tag ?? "\u042D\u043A\u0441\u043F\u0435\u0440\u0442 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0430" }),
      /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex flex-col gap-6 flex-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("h3", { className: "h3 text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "flex-1 flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(
          RichText,
          {
            text: expert.bio,
...
function ExpertCardVertical({ expert }) {
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex flex-col bg-[#121212] p-5 gap-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(
      "div",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("h3", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: expert.name }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(
          RichText,
          {
            text: expert.bio,
...
function ExpertsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "hidden lg:block mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: "grid grid-cols-2 gap-1", children: [
          experts.map((expert, i) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(ExpertCardHorizontal, { expert }, i)),
          isOdd && /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "flex items-center justify-center h-[349px] p-4", children: /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(CirclePattern, { className: "w-full h-full" }) })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "hidden md:block lg:hidden px-8", children: /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "flex flex-col gap-1", children: experts.map((expert, i) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(ExpertCardHorizontal, { expert }, i)) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "block md:hidden px-5", children: /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: "flex flex-col gap-1", children: experts.map((expert, i) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(ExpertCardVertical, { expert }, i)) }) })
      ]
    }
  );
}
...
function Avatar2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
    "div",
    {
      ...
      children: !expert.image && /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("div", { className: "flex h-full w-full items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-18)] font-bold text-[#F0F0F0]", children: expert.name.slice(0, 1) }) })
    }
  );
}
function SingleExpert({ expert, quote }) {
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "flex flex-col justify-center gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: expert.name }),
        expert.tag && /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: expert.tag })
      ] })
    ] }),
    quote && /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#939393]", children: quote })
  ] });
}
function MultiExperts({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "relative w-full", ref: containerRef, children: [
      /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
            "div",
            {
              ...
              children: tipContent && /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-24)] font-bold uppercase leading-[1.16] tracking-[-0.01em] text-[#F0F0F0]", children: tipContent.name }),
                tipContent.tag && /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("span", { className: "text-[length:var(--text-14)] leading-[1.32] tracking-[0.01em] text-[#939393]", children: tipContent.tag })
              ] })
            }
          )
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("div", { className: "flex items-center", children: visible.map((expert, i) => /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
        Avatar2,
        {
          expert,
          overlap: i > 0,
...
function HeroExperts({
  ...
  if (experts.length === 0) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("div", { className, children: experts.length === 1 ? /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(SingleExpert, { expert: experts[0], quote }) : /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(MultiExperts, { experts, quote, maxVisible }) });
}
...
function ToolsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "hidden lg:flex flex-col gap-[88px] mx-auto max-w-[1512px] px-5 md:px-8 xl:px-14", children: [
          descriptionBelow ? /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("h2", { className: "h2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)(import_jsx_runtime48.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                  /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
                ] }) : null
              ] })
            ] }),
            hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("div", { className: "max-w-[668px]", children: /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" }) })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "flex", children: [
            /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "w-1/2 shrink-0 pr-8 flex flex-col gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
              /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("h2", { className: "h2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
                titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)(import_jsx_runtime48.Fragment, { children: [
            ...
            hasParagraphs && /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("div", { className: "w-1/2 flex items-end", children: /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("div", { className: "max-w-[668px]", children: /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(StyledParagraphs, { paragraphs: resolvedParagraphs, theme: "dark", size: "18" }) }) })
          ] }),
          (() => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "hidden md:flex lg:hidden flex-col gap-10 px-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "font-[family-name:var(--font-mono-family)] text-[length:var(--text-18)] font-medium uppercase leading-[1.12] tracking-[0.02em] text-[#FFCC00]", children: tag }),
            /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)("h2", { className: "font-[family-name:var(--font-heading-family)] text-[length:var(--text-28)] font-bold uppercase leading-[1.16] tracking-[-0.01em]", children: [
              /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#F0F0F0]", children: title }),
              titleSecondary ? /* @__PURE__ */ (0, import_jsx_runtime48.jsxs)(import_jsx_runtime48.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#F0F0F0]", children: " " }),
                /* @__PURE__ */ (0, import_jsx_runtime48.jsx)("span", { className: "text-[#939393]", children: titleSecondary })
...
function AccordionFAQ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("div", { className: cn("w-full max-w-3xl", className), children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react8.Accordion.Root, { defaultValue: defaultOpen, className: "w-full", children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(
    import_react8.Accordion.Item,
    {
      value: item.id,
      className: "border-b border-border",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react8.Accordion.Header, { children: /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_react8.Accordion.Trigger, { className: "w-full text-left py-5 pl-6 md:pl-14 flex items-start gap-4 cursor-pointer text-foreground/20 transition-colors duration-200 data-[panel-open]:text-primary hover:text-foreground/50", children: [
          /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("span", { className: "text-[length:var(--text-12)] font-[family-name:var(--font-mono-family)] mt-2 shrink-0 tabular-nums", children: item.id }),
          /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("span", { className: "font-[family-name:var(--font-heading-family)] font-bold uppercase text-3xl md:text-[length:var(--text-52)] leading-none tracking-[-0.02em]", children: item.q })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react8.Accordion.Panel, { className: "accordion-05-panel", children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("div", { className: "overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("p", { className: "pb-6 pl-6 md:px-20 text-[length:var(--text-14)] text-muted-foreground", children: item.a }) }) })
      ]
    },
    item.id
  )) }) });
...
function CTASectionDark({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime50.jsx)("section", { className: cn("dark bg-background text-foreground", className), children: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)("div", { className: "mx-auto w-full max-w-[1512px] px-5 md:px-8 xl:px-14 pb-14 xl:pb-20", children: /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)("div", { className: "relative overflow-hidden border border-border bg-[#0A0A0A] min-h-[320px] xl:min-h-[424px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)("div", { className: "relative z-10 flex flex-col gap-9 p-8 xl:p-14 xl:max-w-[764px]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime50.jsx)("h2", { className: "font-heading text-[28px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.08] tracking-[-0.02em] text-foreground", children: heading }),
        /* @__PURE__ */ (0, import_jsx_runtime50.jsx)("p", { className: "text-[15px] xl:text-[18px] leading-[1.2] text-muted-foreground xl:max-w-[672px]", children: body })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(
        "a",
        {
...
function CTASectionYellow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("section", { className: cn("px-5 md:px-8 xl:px-14 pb-5 md:pb-8 xl:pb-14", className), children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("div", { className: "mx-auto max-w-[1512px]", children: /* @__PURE__ */ (0, import_jsx_runtime51.jsxs)("div", { className: "bg-[#FFCC00] relative overflow-hidden rounded-none aspect-[353/571] md:aspect-auto md:min-h-[320px] xl:min-h-[400px]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(
      "div",
      {
        className: "absolute inset-0 pointer-events-none md:hidden",
        "aria-hidden": "true",
        children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(SpiralMobile, { className: "w-full h-full object-cover object-center" })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(
      "div",
      {
        ...
        "aria-hidden": "true",
        children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(SpiralDesktop, { className: "h-full w-auto object-contain" })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("div", { className: "relative z-10 p-5 md:px-8 md:py-11 xl:px-14", children: /* @__PURE__ */ (0, import_jsx_runtime51.jsxs)("div", { className: "flex flex-col gap-9 md:max-w-[75%] lg:max-w-[50%]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime51.jsxs)("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("h2", { className: "font-heading text-[24px] md:text-[40px] xl:text-[52px] font-bold uppercase leading-[1.2] md:leading-[1.08] tracking-[-0.01em] md:tracking-[-0.02em] text-[#0A0A0A]", children: heading }),
        /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("p", { className: "text-[14px] md:text-[15px] xl:text-[18px] leading-[1.32] text-[#0A0A0A]", children: body })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(
        "a",
        {
...
function LogoSequence({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(
    "div",
    {
      ...
      children: logos.map((logo) => /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(
        "div",
        {
...
function InfiniteLogoMarquee({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)("div", { className: `partner-logo-marquee-track${reverse ? " partner-logo-marquee-track--ltr" : ""}`, style: marqueeStyle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(LogoSequence, { logos, gap, maxLogoHeight }),
        /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(LogoSequence, { logos, gap, maxLogoHeight })
      ] })
    }
  );
...
function BurgerIcon({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)("div", { className: "relative h-[10px] w-[40px]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("span", { className: cn(bar, open ? "top-[4px] rotate-45" : "top-0") }),
    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("span", { className: cn(bar, open ? "top-[4px] -rotate-45" : "top-[8px]") })
  ] });
}
function MobileNav({
  className,
  ...
  const overlay = mounted ? (0, import_react_dom.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(import_react10.AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)(
      import_react10.motion.div,
      {
        ...
        children: [
          origin && /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
            "button",
            {
              type: "button",
              onClick: close,
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(BurgerIcon, { open: true, barClass: "bg-black" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)(
            "nav",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("p", { className: "mb-6 font-mono text-[11px] uppercase tracking-[0.1em] text-black/30", children: "Navigation" }),
                navItems.map((item, index) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
                    import_react10.motion.div,
                    {
                      ...
                      children: hasDropdown ? /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)(import_jsx_runtime53.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
                                "svg",
                                {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("path", { d: "M1 1L5 5L9 1" })
                                }
                              )
                            ]
                          }
                        ),
                        /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(import_react10.AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
                          import_react10.motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)("div", { className: "grid gap-0.5 pb-5", children: [
                              /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
                                import_link3.default,
                                {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black/50", children: "\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A \u0440\u0430\u0437\u0434\u0435\u043B\u0443" })
                                }
                              ),
                              item.items.map((sub) => /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)(
                                import_link3.default,
                                {
                                  href: sub.href,
                                  onClick: close,
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("span", { className: "block font-mono text-[13px] uppercase tracking-[0.06em] text-black", children: sub.title }),
                                    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("span", { className: "mt-1 block text-[13px] leading-[1.45] text-black/50", children: sub.description })
                                  ]
                                },
                                sub.href
                              ))
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)("div", { className: cn("hero-burger", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
      "button",
      {
        ref: triggerRef,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(BurgerIcon, { open: isOpen })
      }
    ),
    overlay
  ] });
...
function RocketmindMenu({
  ...
  return (
    // gap-0.5 at the end wins over gap-5 lg:gap-7 coming from className via tailwind-merge
    /* @__PURE__ */ (0, import_jsx_runtime54.jsxs)("div", { className: cn("relative z-10 flex items-center", className, "gap-0 lg:gap-0"), children: [
      dropdownItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(
        NavigationMenu,
        {
          className: cn(
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(NavigationMenuList, { className: "flex list-none items-center gap-0.5", children: dropdownItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(
            DropdownSection,
            {
              item,
              itemClassName
      ...
      plainItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("nav", { className: "flex list-none items-center gap-0.5", children: plainItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(import_link4.default, { href: item.href, className: linkClass, children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("span", { children: item.label }) }, item.label)) })
    ] })
  );
}
function DropdownSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime54.jsxs)(NavigationMenuItem, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(
      NavigationMenuTrigger,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("span", { children: item.label })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(NavigationMenuContent, { children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(
      "ul",
      {
        className: cn(
          "grid gap-0.5 p-2",
        ...
        children: item.items.map((navItem) => /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime54.jsxs)(
          import_link4.default,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("span", { className: "font-mono text-[11px] uppercase tracking-[0.08em] text-foreground", children: navItem.title }),
              /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("span", { className: "mt-0.5 text-[12px] leading-[1.4] text-muted-foreground", children: navItem.description })
            ]
          }
        ) }) }, navItem.href))
      }
...
function FooterColumn({ title, links }) {
  return /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime57.jsx)("p", { className: "font-mono text-[11px] uppercase tracking-[0.1em] text-muted-foreground/50", children: title }),
    /* @__PURE__ */ (0, import_jsx_runtime57.jsx)("ul", { className: "mt-4 flex flex-col gap-2.5", children: links.map((link) => /* @__PURE__ */ (0, import_jsx_runtime57.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
...
function SiteFooter({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("footer", { className: className ?? "relative overflow-hidden border-t border-border bg-background", children: [
    /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "relative z-10 mx-auto max-w-[1512px] px-5 py-12 md:px-8 md:py-16 xl:px-14", children: [
      /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(import_link5.default, { href: "/", className: "inline-flex items-center", children: /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
          "img",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(import_lucide_react8.ChevronUp, { size: 20, strokeWidth: 2 })
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "mt-10 grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12", children: [
        /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "flex flex-col justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(FooterColumn, { title: "\u041A\u043E\u043D\u0441\u0430\u043B\u0442\u0438\u043D\u0433", links: consultingLinks.slice(0, 4) }),
          /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("p", { className: "mt-8 text-[13px] text-muted-foreground/50 hidden md:block", children: [
            "\xA9 ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " Rocketmind"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(FooterColumn, { title: "\xA0", links: consultingLinks.slice(4) }),
        /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "flex flex-col gap-10", children: [
          /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(FooterColumn, { title: "\u041E\u043D\u043B\u0430\u0439\u043D-\u0448\u043A\u043E\u043B\u0430", links: academyLinks }),
          /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(FooterColumn, { title: "AI-\u043F\u0440\u043E\u0434\u0443\u043A\u0442\u044B", links: aiProductLinks })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(FooterColumn, { title: "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F", links: resolvedCompanyLinks })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("p", { className: "mt-10 text-[13px] text-muted-foreground/50 md:hidden", children: [
        "\xA9 ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Rocketmind"
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)("div", { className: "relative h-[440px] md:h-[460px]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(DottedSurface2, {}),
      children && /* @__PURE__ */ (0, import_jsx_runtime57.jsx)("div", { className: "pointer-events-auto absolute inset-0 z-10 flex flex-col justify-end", children })
    ] })
  ] });
}
...
function SiteHeader({ basePath = "", className, nav }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(
    "header",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime58.jsxs)("div", { className: "mx-auto flex w-full max-w-[1512px] items-center justify-between gap-6 px-5 md:px-8 xl:px-14", children: [
        /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(import_link6.default, { href: "/", className: "flex items-center", children: /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(
          "img",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(MobileNav, { className: "ml-auto", nav })
      ] })
    }
  );
}
