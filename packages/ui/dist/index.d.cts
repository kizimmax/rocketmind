 ...
 */
declare function CoverSkeleton({ className }: CoverSkeletonProps): react_jsx_runtime.JSX.Element;
...
interface PartnershipsMiniLogo {
    src: string;
    alt: string;
}
interface PartnershipsMiniProps {
    title: string;
    description: string;
 ...
 */
declare function PartnershipsMini({ title, description, logos, className, }: PartnershipsMiniProps): react_jsx_runtime.JSX.Element;
...
interface GlossaryPopularRowProps extends React$1.HTMLAttributes<HTMLDivElement> {
    /**
 ...
 */
declare function GlossaryPopularRow({ items, className, ...props }: GlossaryPopularRowProps): react_jsx_runtime.JSX.Element | null;
/**
...
declare function ListCardGrid({ cards, listType, cols, className, }: {
    cards: ListCardData[];
...
interface AdminShellSubSection {
    id: string;
    label: string;
}
interface AdminShellSection {
    id: string;
    href: string;
    label: string;
    Icon: LucideIcon;
