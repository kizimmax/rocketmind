...
>
> **Version:** 1.5.0 · **Updated:** 2026-03-17
...
:root {
  ...
  */
  ...
  --secondary: var(--rm-gray-1);
  --secondary-foreground: var(--rm-gray-fg-main);
...
> **Подключение:** Google Fonts: `Roboto Condensed` (400, 700, 800), `Roboto` (400, 500), `Shantell Sans` (400). Локальный шрифт: `Loos Condensed` (OTF, Medium) — `/fonts/LoosCond-Medium.otf`.
...
| `copy-14` | 14 | 400 Regular | 1.4 | 0.01em | Small, caption, подпись |
| `copy-14-mono` | 14 | 400 Regular | 1.4 | 0.02em | Inline code, технические строки |
...
| `--radius-sm` | `4` | `0.25rem` | `rounded-sm` | **Button, Input**, badge, tag, tooltip, kbd |
| `--radius` | `6` | `0.375rem` | `rounded-md` | Card, Select, Dropdown |
...
|-----------|---------|-----------|-------|
| `default` | bg `#FFCC00`, text `#121212` | bg `--rm-gray-1`, border `--border`, text `--foreground` | bg transparent, text `--muted-foreground` |
| `hover` | bg `#FFE040` (–10% яркости) | bg `--rm-gray-2` | bg `--rm-gray-2`, text `--foreground` |
| `active` | bg `#E6B800` (–20%) | bg `--rm-gray-3` | bg `--rm-gray-3`, text `--foreground` |
...
className="
  ...
  font-mono text-[13px] uppercase tracking-[0.08em]
  transition-all duration-150
  hover:bg-[var(--rm-gray-2)] hover:text-foreground active:bg-[var(--rm-gray-3)] active:text-foreground
  focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring
