...
| 2 | `--rm-gray-2` | `#F5F5F5` | `#1A1A1A` | Тихая поверхность — `muted`, `secondary` |
| 3 | `--rm-gray-3` | `#EBEBEB` | `#242424` | Hover-фон компонентов — `accent` |
...
|-------------|----------|-----------|----------|----------|
| `background` | — | `#FFFFFF` | `#0A0A0A` | Основной фон страницы |
| `foreground` | `--rm-gray-fg` | `#2D2D2D` | `#F0F0F0` | Основной текст |
| `muted` | `--rm-gray-2` | `#F5F5F5` | `#1A1A1A` | Приглушённый фон |
...
| `card` | `--rm-gray-1` | `#FAFAFA` | `#121212` | Фон карточек |
| `card-foreground` | `--rm-gray-fg` | `#2D2D2D` | `#F0F0F0` | Текст в карточках |
| `popover` | `--rm-gray-1` | `#FAFAFA` | `#121212` | Фон поповеров/дропдаунов |
| `popover-foreground` | `--rm-gray-fg` | `#2D2D2D` | `#F0F0F0` | Текст в поповерах |
| `secondary` | `--rm-gray-2` | `#F5F5F5` | `#1A1A1A` | Второстепенный фон |
...
|--------------|-----|-------------|------|
| Фон светлый | `#FFFFFF` | `--background` | Фон страниц |
