...
>
> **Version:** 1.3.0 · **Updated:** 2026-03-17
...
| `copy-12` | 12 | 400 Regular | 1.5 | 0.02em | Micro, copyright, служебный текст |
...
| `hover` | bg `#FFE040` (–10% яркости) | bg `--rm-gray-3` | bg `--rm-gray-3`, text `--foreground` |
| `active` | bg `#E6B800` (–20%) | bg `--rm-gray-3` | bg `--rm-gray-3` |
...
| `disabled` | opacity `0.4`, cursor `not-allowed`, bg `--rm-gray-2` |
...
| `loading` | skeleton `--rm-gray-2` пульсирует | skeleton `--rm-gray-2` |
...
- **Badge:** mono-шрифт, uppercase, `4px` radius, `--rm-gray-2` фон
...
.skeleton {
  background: linear-gradient(
    90deg,
    var(--rm-gray-2) 0%,
    hsl(from var(--rm-gray-2) h s calc(l + 5%)) 50%,
    var(--rm-gray-2) 100%
  );
